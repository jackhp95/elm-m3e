...
description: >-
  ...
  Covers the named-slot vs M3e.Aria.label / M3e.ariaLabel decision, what @m3e/web handles
...
The ARIA setter exists on three surfaces (pick by your build surface):

- Barrel: `M3e.ariaLabel "Back"` / `M3e.ariaLabelledby "…"`
- Mid layer: `M3e.Aria.label "Back"` / `M3e.Aria.labelledby "…"`
