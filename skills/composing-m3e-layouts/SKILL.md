...
description: >-
  ...
  For picking a component surface see building-m3e-uis; for theming/tokens see
...
Each producer returns an *open* row (`{ s | listItem : Supported }`), which widens to fill
