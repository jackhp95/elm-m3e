...
import M3e.Html.Attr as CemAttr
...
{-| Replacement for the retired `Content.slotWithAttr`, composed from the
...
suite =
    describe "IR-core runtime reductions"
        ...
        , describe "slotWithAttr (withSlot + withAttr) — for/id auto-wiring"
