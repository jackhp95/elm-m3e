...
menuNode : List (Menu.Option msg) -> List (Renderable.Renderable { menuItem : Renderable.Supported } msg) -> Node.Node msg
menuNode opts items =
    Menu.view { items = items } opts
        |> Renderable.toNode


plainItem : Renderable.Renderable { menuItem : Renderable.Supported } String
plainItem =
