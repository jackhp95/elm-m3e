...
trailingSlot icon =
    case icon of
        ...
        Just i ->
            [ slottedIcon M3e.Button.trailingSlotIcon i ]
...
variantAttr v =
    case v of
        Elevated ->
            M3e.Button.variantElevated

        Filled ->
            M3e.Button.variantFilled

        Tonal ->
            M3e.Button.variantTonal

        Outlined ->
            M3e.Button.variantOutlined

        Text ->
            M3e.Button.variantText
...
sizeAttr s =
    case s of
        ExtraSmall ->
            M3e.Button.sizeExtraSmall

        Small ->
            M3e.Button.sizeSmall

        Medium ->
            M3e.Button.sizeMedium

        Large ->
            M3e.Button.sizeLarge

        ExtraLarge ->
            M3e.Button.sizeExtraLarge
...
shapeAttr shape =
    case shape of
        ...
        Just Round ->
            [ M3e.Button.shapeRounded ]

        Just Square ->
            [ M3e.Button.shapeSquare ]
