    ...
    case cfg.kind of
        Assist ->
            M3e.AssistChip.component
                (List.filterMap identity
                    [ Just (Attr.id cfg.id)
                    , Just (genericStyle cfg.elevated M3e.AssistChip.variantElevated M3e.AssistChip.variantOutlined)
        ...
        Suggestion ->
            M3e.SuggestionChip.component
                (List.filterMap identity
                    [ Just (Attr.id cfg.id)
                    , Just (genericStyle cfg.elevated M3e.SuggestionChip.variantElevated M3e.SuggestionChip.variantOutlined)
        ...
        FilterKind ->
            M3e.FilterChip.component
                (List.filterMap identity
                    [ Just (Attr.id cfg.id)
                    , Just (genericStyle cfg.elevated M3e.FilterChip.variantElevated M3e.FilterChip.variantOutlined)
        ...
        InputKind ->
            M3e.InputChip.component
                (List.filterMap identity
                    [ Just (Attr.id cfg.id)
                    , Just (genericStyle cfg.elevated M3e.InputChip.variantElevated M3e.InputChip.variantOutlined)
