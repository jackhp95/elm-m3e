...
```elm
[ M3e.FormField.view [ M3e.FormField.variant M3e.Value.outlined ] [ M3e.FormField.label "fld1" (Native.node Html.label [ Native.attribute "for" "fld1" ] [ Kit.text "Outlined" ]), M3e.FormField.control "fld1" (Native.node Html.input [ Native.attribute "id" "fld1" ] []) ]
    , M3e.FormField.view [ M3e.FormField.variant M3e.Value.filled ] [ M3e.FormField.label "fld2" (Native.node Html.label [ Native.attribute "for" "fld2" ] [ Kit.text "Filled" ]), M3e.FormField.control "fld2" (Native.node Html.input [ Native.attribute "id" "fld2" ] []) ]
    ]
```
...
```elm
M3e.FormField.view [ M3e.FormField.floatLabel M3e.Value.always ] [ M3e.FormField.label "fld3" (Native.node Html.label [ Native.attribute "for" "fld3" ] [ Kit.text "Always float label" ]), M3e.FormField.control "fld3" (Native.node Html.input [ Native.attribute "id" "fld3" ] []) ]
```

<!-- elm-cem:example title="Hint labels" -->
```elm
M3e.FormField.view [ M3e.FormField.hideSubscript M3e.Value.auto ] [ M3e.FormField.label "fld4" (Native.node Html.label [ Native.attribute "for" "fld4" ] [ Kit.text "Field w/ hint" ]), M3e.FormField.control "fld4" (Native.node Html.input [ Native.attribute "id" "fld4" ] []), M3e.FormField.hint (Native.span [] [ Kit.text "Hint text" ]) ]
```
