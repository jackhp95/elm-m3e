module M3e.SplitPane exposing (disabled, end, label, max, min, name, onBeforeinput, onChange, onInput, orientation, overshootLimit, splitPane, start, step, value, wrapDetents)

{-| 
@docs splitPane, label, max, min, orientation, overshootLimit, step, value, wrapDetents, name, disabled, onChange, onBeforeinput, onInput, start, end
-}
