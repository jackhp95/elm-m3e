...
```elm
M3e.ButtonGroup.view [ M3e.ButtonGroup.variant M3e.Value.connected ] (M3e.ButtonGroup.children [ M3e.Button.view { content = Kit.text "List", action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True, M3e.Button.selected True ] [ M3e.Button.icon (M3e.Icon.view [ M3e.Icon.name "view_list" ] []) ], M3e.Button.view { content = Kit.text "Grid", action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True ] [ M3e.Button.icon (M3e.Icon.view [ M3e.Icon.name "grid_view" ] []) ], M3e.Button.view { content = Kit.text "Map", action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True ] [ M3e.Button.icon (M3e.Icon.view [ M3e.Icon.name "map" ] []) ] ])
```

<!-- elm-cem:example title="Multi-select formatting toolbar" -->
```elm
M3e.ButtonGroup.view [ M3e.ButtonGroup.variant M3e.Value.connected, M3e.ButtonGroup.multi True, M3e.ButtonGroup.size M3e.Value.medium ] (M3e.ButtonGroup.children [ M3e.Button.view { content = M3e.Icon.view [ M3e.Icon.name "format_bold" ] [], action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True, M3e.Aria.label "Bold" ] [], M3e.Button.view { content = M3e.Icon.view [ M3e.Icon.name "format_italic" ] [], action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True, M3e.Aria.label "Italic" ] [], M3e.Button.view { content = M3e.Icon.view [ M3e.Icon.name "format_underlined" ] [], action = M3e.Action.none } [ M3e.Button.variant M3e.Value.tonal, M3e.Button.shape M3e.Value.square, M3e.Button.toggle True, M3e.Aria.label "Underline" ] [] ])
```
