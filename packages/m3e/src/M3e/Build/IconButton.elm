...
width :
    ...
    -> Builder { a | width : M3e.Build.Internal.Available } s msg
    -> Builder { a | width : M3e.Build.Internal.Used } s msg
width v_ (Builder f_) =
    Builder { f_ | width = Just v_ }
             ...
             (List.concat
                  ...
                  , Maybe.withDefault
                      ...
                      (Maybe.map
                         (\v_ ->
                            [ M3e.Cem.Attr.forget
                                (M3e.Cem.IconButton.disabled v_)
                            ]
                         )
                         f_.disabled
                      )
                  ...
                  , Maybe.withDefault
                      ...
                      (Maybe.map
                         (\v_ ->
                            [ M3e.Cem.Attr.forget
                                (M3e.Cem.IconButton.selected v_)
                            ]
                         )
                         f_.selected
                      )
