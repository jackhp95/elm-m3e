module M3e.Build.ListItem.Slots exposing
...
leading_core :
    ...
    -> M3e.Build.ListItem.Builder pa { ps
...
{-| Place a `Icon` in the `leading` slot of `ListItem`. -}
leadingIcon :
...
{-| Place a `Icon` in the `trailing` slot of `ListItem`. -}
trailingIcon :
    M3e.Build.Icon.Builder ca cs msg ck
    -> M3e.Build.ListItem.Builder pa { ps
        | trailing : M3e.Build.Internal.Available
