module M3e.Build.Skeleton.Slots exposing
...
{-|
Slot setters for `M3e.Build.Skeleton`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.Skeleton.Builder pa ps msg pk
    -> M3e.Build.Skeleton.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `Skeleton`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `Skeleton`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `Skeleton`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `Skeleton`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `Skeleton`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `Skeleton`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `Skeleton`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `Skeleton`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `Skeleton`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `Skeleton`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `Skeleton`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `Skeleton`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `Skeleton`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `Skeleton`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `Skeleton`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `Skeleton`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `Skeleton`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `Skeleton`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `Skeleton`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `Skeleton`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `Skeleton`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `Skeleton`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `Skeleton`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `Skeleton`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `Skeleton`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `Skeleton`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `Skeleton`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `Skeleton`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `Skeleton`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `Skeleton`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `Skeleton`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `Skeleton`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `Skeleton`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `Skeleton`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `Skeleton`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `Skeleton`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `Skeleton`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `Skeleton`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `Skeleton`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `Skeleton`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `Skeleton`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `Skeleton`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `Skeleton`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `Skeleton`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `Skeleton`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `Skeleton`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `Skeleton`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `Skeleton`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `Skeleton`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `Skeleton`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `Skeleton`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `Skeleton`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `Skeleton`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `Skeleton`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `Skeleton`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `Skeleton`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `Skeleton`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `Skeleton`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `Skeleton`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `Skeleton`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `Skeleton`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `Skeleton`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `Skeleton`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `Skeleton`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `Skeleton`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `Skeleton`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `Skeleton`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `Skeleton`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `Skeleton`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `Skeleton`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `Skeleton`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `Skeleton`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `Skeleton`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `Skeleton`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `Skeleton`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `Skeleton`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `Skeleton`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `Skeleton`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `Skeleton`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `Skeleton`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `Skeleton`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `Skeleton`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `Skeleton`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `Skeleton`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `Skeleton`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `Skeleton`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `Skeleton`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `Skeleton`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `Skeleton`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `Skeleton`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `Skeleton`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `Skeleton`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `Skeleton`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `Skeleton`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `Skeleton`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `Skeleton`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `Skeleton`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `Skeleton`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `Skeleton`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `Skeleton`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `Skeleton`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `Skeleton`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `Skeleton`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `Skeleton`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `Skeleton`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `Skeleton`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `Skeleton`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `Skeleton`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `Skeleton`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `Skeleton`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `Skeleton`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `Skeleton`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `Skeleton`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `Skeleton`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `Skeleton`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `Skeleton`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `Skeleton`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `Skeleton`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `Skeleton`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `Skeleton`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `Skeleton`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `Skeleton`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `Skeleton`. -}
actionElementBase :
