module M3e.Build.SlideGroup.Slots exposing
    ( nextIconIcon, prevIconIcon, tree, treeItem, toolbar, toc
    , tocItem, themeIcon, theme, textareaAutosize, tabs, tabPanel, tab
    , switch, stepperReset, stepperPrevious, step, stepPanel, stepper, splitPane
    , splitButton, snackbar, slider, sliderThumb, slideGroup, skeleton, shape
    , segmentedButton, buttonSegment, searchView, searchBar, radioGroup, radio, progressElementIndicatorBase
    , paginator, select, navRailToggle, navRail, navMenuItemGroup, navMenu, navMenuItem
    , navBar, navItem, menuItemRadio, menuItemGroup, menuItemCheckbox, menu, menuItem
    , menuTrigger, menuItemElementBase, loadingIndicator, selectionList, listOption, actionList, expandableListItem
    , listAction, listItemButton, list, listItem, icon, heading, fabMenuTrigger
...
@docs nextIconIcon, prevIconIcon, tree, treeItem, toolbar, toc
@docs tocItem, themeIcon, theme, textareaAutosize, tabs, tabPanel
@docs tab, switch, stepperReset, stepperPrevious, step, stepPanel
@docs stepper, splitPane, splitButton, snackbar, slider, sliderThumb
@docs slideGroup, skeleton, shape, segmentedButton, buttonSegment, searchView
@docs searchBar, radioGroup, radio, progressElementIndicatorBase, paginator, select
@docs navRailToggle, navRail, navMenuItemGroup, navMenu, navMenuItem, navBar
@docs navItem, menuItemRadio, menuItemGroup, menuItemCheckbox, menu, menuItem
@docs menuTrigger, menuItemElementBase, loadingIndicator, selectionList, listOption, actionList
@docs expandableListItem, listAction, listItemButton, list, listItem, icon
@docs heading, fabMenuTrigger, fabMenu, fab, accordion, expansionPanel
...
@docs pseudoCheckbox, focusRing, elevation, collapsible, actionElementBase
-}
...
{-| Place a `Tree` in the `unnamed` slot of `SlideGroup`. -}
tree :
