module M3e.Build.MenuTrigger exposing
    ( Builder, AttrCaps, SlotCaps, menuTrigger, for, child
    , build
    )
...
@docs Builder, AttrCaps, SlotCaps, menuTrigger, for, child
@docs build
-}
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
             (M3e.Cem.Attr.Internal.forget (M3e.Cem.MenuTrigger.for v_))
...
build :
    ...
    -> M3e.Element.Element { menuTrigger : M3e.Value.Supported } msg
build b_ =
