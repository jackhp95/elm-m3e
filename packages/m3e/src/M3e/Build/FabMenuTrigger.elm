module M3e.Build.FabMenuTrigger exposing
    ( Builder, AttrCaps, SlotCaps, fabMenuTrigger, for, child
    , build
    )
...
@docs Builder, AttrCaps, SlotCaps, fabMenuTrigger, for, child
@docs build
-}
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
             (M3e.Cem.Attr.Internal.forget (M3e.Cem.FabMenuTrigger.for v_))
