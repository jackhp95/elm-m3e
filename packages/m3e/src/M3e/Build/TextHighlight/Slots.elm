module M3e.Build.TextHighlight.Slots exposing
...
{-|
Slot setters for `M3e.Build.TextHighlight`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.TextHighlight.Builder pa ps msg pk
    -> M3e.Build.TextHighlight.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `TextHighlight`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `TextHighlight`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `TextHighlight`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `TextHighlight`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `TextHighlight`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `TextHighlight`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `TextHighlight`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `TextHighlight`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `TextHighlight`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `TextHighlight`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `TextHighlight`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `TextHighlight`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `TextHighlight`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `TextHighlight`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `TextHighlight`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `TextHighlight`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `TextHighlight`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `TextHighlight`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `TextHighlight`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `TextHighlight`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `TextHighlight`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `TextHighlight`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `TextHighlight`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `TextHighlight`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `TextHighlight`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `TextHighlight`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `TextHighlight`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `TextHighlight`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `TextHighlight`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `TextHighlight`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `TextHighlight`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `TextHighlight`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `TextHighlight`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `TextHighlight`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `TextHighlight`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `TextHighlight`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `TextHighlight`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `TextHighlight`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `TextHighlight`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `TextHighlight`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `TextHighlight`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `TextHighlight`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `TextHighlight`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `TextHighlight`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `TextHighlight`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `TextHighlight`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `TextHighlight`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `TextHighlight`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `TextHighlight`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `TextHighlight`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `TextHighlight`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `TextHighlight`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `TextHighlight`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `TextHighlight`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `TextHighlight`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `TextHighlight`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `TextHighlight`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `TextHighlight`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `TextHighlight`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `TextHighlight`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `TextHighlight`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `TextHighlight`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `TextHighlight`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `TextHighlight`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `TextHighlight`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `TextHighlight`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `TextHighlight`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `TextHighlight`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `TextHighlight`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `TextHighlight`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `TextHighlight`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `TextHighlight`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `TextHighlight`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `TextHighlight`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `TextHighlight`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `TextHighlight`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `TextHighlight`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `TextHighlight`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `TextHighlight`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `TextHighlight`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `TextHighlight`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `TextHighlight`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `TextHighlight`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `TextHighlight`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `TextHighlight`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `TextHighlight`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `TextHighlight`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `TextHighlight`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `TextHighlight`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `TextHighlight`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `TextHighlight`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `TextHighlight`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `TextHighlight`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `TextHighlight`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `TextHighlight`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `TextHighlight`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `TextHighlight`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `TextHighlight`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `TextHighlight`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `TextHighlight`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `TextHighlight`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `TextHighlight`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `TextHighlight`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `TextHighlight`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `TextHighlight`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `TextHighlight`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `TextHighlight`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `TextHighlight`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `TextHighlight`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `TextHighlight`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `TextHighlight`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `TextHighlight`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `TextHighlight`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `TextHighlight`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `TextHighlight`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `TextHighlight`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `TextHighlight`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `TextHighlight`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `TextHighlight`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `TextHighlight`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `TextHighlight`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `TextHighlight`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `TextHighlight`. -}
actionElementBase :
