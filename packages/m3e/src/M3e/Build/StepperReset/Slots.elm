module M3e.Build.StepperReset.Slots exposing
...
default_core :
    ...
    -> M3e.Build.StepperReset.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `StepperReset`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `StepperReset`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `StepperReset`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `StepperReset`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `StepperReset`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `StepperReset`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `StepperReset`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `StepperReset`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `StepperReset`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `StepperReset`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `StepperReset`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `StepperReset`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `StepperReset`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `StepperReset`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `StepperReset`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `StepperReset`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `StepperReset`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `StepperReset`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `StepperReset`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `StepperReset`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `StepperReset`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `StepperReset`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `StepperReset`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `StepperReset`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `StepperReset`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `StepperReset`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `StepperReset`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `StepperReset`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `StepperReset`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `StepperReset`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `StepperReset`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `StepperReset`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `StepperReset`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `StepperReset`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `StepperReset`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `StepperReset`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `StepperReset`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `StepperReset`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `StepperReset`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `StepperReset`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `StepperReset`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `StepperReset`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `StepperReset`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `StepperReset`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `StepperReset`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `StepperReset`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `StepperReset`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `StepperReset`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `StepperReset`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `StepperReset`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `StepperReset`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `StepperReset`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `StepperReset`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `StepperReset`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `StepperReset`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `StepperReset`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `StepperReset`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `StepperReset`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `StepperReset`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `StepperReset`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `StepperReset`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `StepperReset`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `StepperReset`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `StepperReset`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `StepperReset`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `StepperReset`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `StepperReset`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `StepperReset`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `StepperReset`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `StepperReset`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `StepperReset`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `StepperReset`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `StepperReset`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `StepperReset`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `StepperReset`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `StepperReset`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `StepperReset`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `StepperReset`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `StepperReset`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `StepperReset`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `StepperReset`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `StepperReset`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `StepperReset`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `StepperReset`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `StepperReset`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `StepperReset`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `StepperReset`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `StepperReset`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `StepperReset`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `StepperReset`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `StepperReset`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `StepperReset`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `StepperReset`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `StepperReset`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `StepperReset`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `StepperReset`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `StepperReset`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `StepperReset`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `StepperReset`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `StepperReset`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `StepperReset`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `StepperReset`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `StepperReset`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `StepperReset`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `StepperReset`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `StepperReset`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `StepperReset`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `StepperReset`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `StepperReset`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `StepperReset`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `StepperReset`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `StepperReset`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `StepperReset`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `StepperReset`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `StepperReset`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `StepperReset`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `StepperReset`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `StepperReset`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `StepperReset`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `StepperReset`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `StepperReset`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `StepperReset`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `StepperReset`. -}
actionElementBase :
