module M3e.Build.Toc.Slots exposing
...
{-|
Slot setters for `M3e.Build.Toc`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
{-| Place a `Tree` in the `unnamed` slot of `Toc`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `Toc`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `Toc`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `Toc`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `Toc`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `Toc`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `Toc`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `Toc`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `Toc`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `Toc`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `Toc`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `Toc`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `Toc`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `Toc`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `Toc`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `Toc`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `Toc`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `Toc`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `Toc`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `Toc`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `Toc`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `Toc`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `Toc`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `Toc`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `Toc`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `Toc`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `Toc`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `Toc`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `Toc`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `Toc`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `Toc`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `Toc`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `Toc`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `Toc`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `Toc`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `Toc`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `Toc`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `Toc`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `Toc`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `Toc`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `Toc`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `Toc`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `Toc`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `Toc`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `Toc`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `Toc`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `Toc`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `Toc`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `Toc`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `Toc`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `Toc`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `Toc`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `Toc`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `Toc`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `Toc`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `Toc`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `Toc`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `Toc`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `Toc`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `Toc`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `Toc`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `Toc`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `Toc`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `Toc`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `Toc`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `Toc`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `Toc`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `Toc`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `Toc`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `Toc`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `Toc`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `Toc`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `Toc`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `Toc`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `Toc`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `Toc`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `Toc`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `Toc`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `Toc`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `Toc`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `Toc`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `Toc`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `Toc`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `Toc`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `Toc`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `Toc`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `Toc`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `Toc`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `Toc`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `Toc`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `Toc`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `Toc`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `Toc`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `Toc`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `Toc`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `Toc`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `Toc`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `Toc`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `Toc`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `Toc`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `Toc`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `Toc`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `Toc`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `Toc`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `Toc`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `Toc`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `Toc`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `Toc`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `Toc`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `Toc`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `Toc`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `Toc`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `Toc`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `Toc`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `Toc`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `Toc`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `Toc`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `Toc`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `Toc`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `Toc`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `Toc`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `Toc`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `Toc`. -}
actionElementBase :
