module M3e.Build.Theme.Slots exposing
...
{-|
Slot setters for `M3e.Build.Theme`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.Theme.Builder pa ps msg pk
    -> M3e.Build.Theme.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `Theme`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `Theme`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `Theme`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `Theme`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `Theme`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `Theme`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `Theme`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `Theme`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `Theme`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `Theme`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `Theme`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `Theme`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `Theme`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `Theme`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `Theme`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `Theme`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `Theme`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `Theme`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `Theme`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `Theme`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `Theme`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `Theme`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `Theme`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `Theme`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `Theme`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `Theme`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `Theme`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `Theme`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `Theme`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `Theme`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `Theme`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `Theme`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `Theme`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `Theme`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `Theme`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `Theme`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `Theme`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `Theme`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `Theme`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `Theme`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `Theme`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `Theme`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `Theme`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `Theme`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `Theme`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `Theme`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `Theme`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `Theme`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `Theme`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `Theme`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `Theme`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `Theme`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `Theme`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `Theme`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `Theme`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `Theme`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `Theme`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `Theme`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `Theme`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `Theme`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `Theme`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `Theme`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `Theme`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `Theme`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `Theme`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `Theme`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `Theme`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `Theme`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `Theme`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `Theme`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `Theme`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `Theme`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `Theme`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `Theme`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `Theme`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `Theme`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `Theme`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `Theme`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `Theme`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `Theme`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `Theme`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `Theme`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `Theme`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `Theme`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `Theme`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `Theme`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `Theme`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `Theme`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `Theme`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `Theme`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `Theme`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `Theme`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `Theme`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `Theme`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `Theme`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `Theme`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `Theme`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `Theme`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `Theme`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `Theme`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `Theme`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `Theme`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `Theme`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `Theme`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `Theme`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `Theme`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `Theme`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `Theme`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `Theme`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `Theme`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `Theme`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `Theme`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `Theme`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `Theme`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `Theme`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `Theme`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `Theme`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `Theme`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `Theme`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `Theme`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `Theme`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `Theme`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `Theme`. -}
actionElementBase :
