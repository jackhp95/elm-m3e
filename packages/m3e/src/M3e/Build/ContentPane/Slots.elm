module M3e.Build.ContentPane.Slots exposing
...
{-|
Slot setters for `M3e.Build.ContentPane`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.ContentPane.Builder pa ps msg pk
    -> M3e.Build.ContentPane.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `ContentPane`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `ContentPane`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `ContentPane`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `ContentPane`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `ContentPane`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `ContentPane`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `ContentPane`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `ContentPane`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `ContentPane`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `ContentPane`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `ContentPane`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `ContentPane`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `ContentPane`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `ContentPane`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `ContentPane`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `ContentPane`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `ContentPane`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `ContentPane`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `ContentPane`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `ContentPane`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `ContentPane`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `ContentPane`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `ContentPane`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `ContentPane`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `ContentPane`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `ContentPane`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `ContentPane`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `ContentPane`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `ContentPane`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `ContentPane`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `ContentPane`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `ContentPane`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `ContentPane`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `ContentPane`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `ContentPane`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `ContentPane`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `ContentPane`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `ContentPane`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `ContentPane`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `ContentPane`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `ContentPane`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `ContentPane`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `ContentPane`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `ContentPane`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `ContentPane`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `ContentPane`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `ContentPane`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `ContentPane`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `ContentPane`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `ContentPane`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `ContentPane`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `ContentPane`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `ContentPane`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `ContentPane`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `ContentPane`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `ContentPane`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `ContentPane`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `ContentPane`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `ContentPane`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `ContentPane`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `ContentPane`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `ContentPane`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `ContentPane`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `ContentPane`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `ContentPane`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `ContentPane`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `ContentPane`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `ContentPane`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `ContentPane`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `ContentPane`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `ContentPane`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `ContentPane`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `ContentPane`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `ContentPane`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `ContentPane`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `ContentPane`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `ContentPane`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `ContentPane`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `ContentPane`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `ContentPane`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `ContentPane`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `ContentPane`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `ContentPane`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `ContentPane`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `ContentPane`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `ContentPane`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `ContentPane`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `ContentPane`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `ContentPane`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `ContentPane`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `ContentPane`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `ContentPane`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `ContentPane`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `ContentPane`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `ContentPane`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `ContentPane`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `ContentPane`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `ContentPane`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `ContentPane`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `ContentPane`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `ContentPane`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `ContentPane`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `ContentPane`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `ContentPane`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `ContentPane`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `ContentPane`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `ContentPane`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `ContentPane`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `ContentPane`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `ContentPane`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `ContentPane`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `ContentPane`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `ContentPane`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `ContentPane`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `ContentPane`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `ContentPane`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `ContentPane`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `ContentPane`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `ContentPane`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `ContentPane`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `ContentPane`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `ContentPane`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `ContentPane`. -}
actionElementBase :
