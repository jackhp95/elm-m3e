module M3e.Build.FocusTrap.Slots exposing
...
{-|
Slot setters for `M3e.Build.FocusTrap`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
unnamed_core :
    ...
    -> M3e.Build.FocusTrap.Builder pa ps msg pk
    -> M3e.Build.FocusTrap.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `FocusTrap`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `FocusTrap`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `FocusTrap`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `FocusTrap`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `FocusTrap`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `FocusTrap`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `FocusTrap`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `FocusTrap`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `FocusTrap`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `FocusTrap`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `FocusTrap`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `FocusTrap`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `FocusTrap`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `FocusTrap`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `FocusTrap`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `FocusTrap`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `FocusTrap`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `FocusTrap`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `FocusTrap`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `FocusTrap`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `FocusTrap`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `FocusTrap`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `FocusTrap`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `FocusTrap`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `FocusTrap`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `FocusTrap`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `FocusTrap`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `FocusTrap`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `FocusTrap`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `FocusTrap`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `FocusTrap`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `FocusTrap`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `FocusTrap`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `FocusTrap`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `FocusTrap`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `FocusTrap`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `FocusTrap`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `FocusTrap`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `FocusTrap`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `FocusTrap`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `FocusTrap`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `FocusTrap`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `FocusTrap`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `FocusTrap`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `FocusTrap`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `FocusTrap`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `FocusTrap`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `FocusTrap`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `FocusTrap`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `FocusTrap`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `FocusTrap`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `FocusTrap`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `FocusTrap`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `FocusTrap`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `FocusTrap`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `FocusTrap`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `FocusTrap`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `FocusTrap`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `FocusTrap`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `FocusTrap`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `FocusTrap`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `FocusTrap`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `FocusTrap`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `FocusTrap`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `FocusTrap`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `FocusTrap`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `FocusTrap`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `FocusTrap`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `FocusTrap`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `FocusTrap`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `FocusTrap`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `FocusTrap`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `FocusTrap`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `FocusTrap`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `FocusTrap`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `FocusTrap`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `FocusTrap`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `FocusTrap`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `FocusTrap`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `FocusTrap`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `FocusTrap`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `FocusTrap`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `FocusTrap`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `FocusTrap`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `FocusTrap`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `FocusTrap`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `FocusTrap`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `FocusTrap`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `FocusTrap`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `FocusTrap`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `FocusTrap`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `FocusTrap`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `FocusTrap`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `FocusTrap`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `FocusTrap`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `FocusTrap`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `FocusTrap`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `FocusTrap`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `FocusTrap`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `FocusTrap`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `FocusTrap`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `FocusTrap`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `FocusTrap`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `FocusTrap`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `FocusTrap`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `FocusTrap`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `FocusTrap`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `FocusTrap`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `FocusTrap`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `FocusTrap`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `FocusTrap`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `FocusTrap`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `FocusTrap`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `FocusTrap`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `FocusTrap`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `FocusTrap`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `FocusTrap`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `FocusTrap`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `FocusTrap`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `FocusTrap`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `FocusTrap`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `FocusTrap`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `FocusTrap`. -}
actionElementBase :
