module M3e.Build.MenuTrigger.Slots exposing
...
{-|
Slot setters for `M3e.Build.MenuTrigger`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.MenuTrigger.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `MenuTrigger`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `MenuTrigger`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `MenuTrigger`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `MenuTrigger`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `MenuTrigger`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `MenuTrigger`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `MenuTrigger`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `MenuTrigger`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `MenuTrigger`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `MenuTrigger`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `MenuTrigger`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `MenuTrigger`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `MenuTrigger`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `MenuTrigger`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `MenuTrigger`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `MenuTrigger`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `MenuTrigger`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `MenuTrigger`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `MenuTrigger`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `MenuTrigger`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `MenuTrigger`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `MenuTrigger`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `MenuTrigger`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `MenuTrigger`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `MenuTrigger`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `MenuTrigger`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `MenuTrigger`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `MenuTrigger`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `MenuTrigger`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `MenuTrigger`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `MenuTrigger`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `MenuTrigger`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `MenuTrigger`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `MenuTrigger`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `MenuTrigger`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `MenuTrigger`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `MenuTrigger`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `MenuTrigger`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `MenuTrigger`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `MenuTrigger`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `MenuTrigger`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `MenuTrigger`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `MenuTrigger`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `MenuTrigger`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `MenuTrigger`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `MenuTrigger`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `MenuTrigger`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `MenuTrigger`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `MenuTrigger`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `MenuTrigger`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `MenuTrigger`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `MenuTrigger`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `MenuTrigger`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `MenuTrigger`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `MenuTrigger`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `MenuTrigger`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `MenuTrigger`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `MenuTrigger`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `MenuTrigger`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `MenuTrigger`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `MenuTrigger`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `MenuTrigger`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `MenuTrigger`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `MenuTrigger`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `MenuTrigger`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `MenuTrigger`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `MenuTrigger`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `MenuTrigger`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `MenuTrigger`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `MenuTrigger`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `MenuTrigger`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `MenuTrigger`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `MenuTrigger`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `MenuTrigger`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `MenuTrigger`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `MenuTrigger`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `MenuTrigger`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `MenuTrigger`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `MenuTrigger`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `MenuTrigger`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `MenuTrigger`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `MenuTrigger`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `MenuTrigger`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `MenuTrigger`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `MenuTrigger`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `MenuTrigger`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `MenuTrigger`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `MenuTrigger`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `MenuTrigger`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `MenuTrigger`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `MenuTrigger`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `MenuTrigger`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `MenuTrigger`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `MenuTrigger`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `MenuTrigger`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `MenuTrigger`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `MenuTrigger`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `MenuTrigger`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `MenuTrigger`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `MenuTrigger`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `MenuTrigger`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `MenuTrigger`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `MenuTrigger`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `MenuTrigger`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `MenuTrigger`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `MenuTrigger`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `MenuTrigger`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `MenuTrigger`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `MenuTrigger`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `MenuTrigger`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `MenuTrigger`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `MenuTrigger`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `MenuTrigger`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `MenuTrigger`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `MenuTrigger`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `MenuTrigger`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `MenuTrigger`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `MenuTrigger`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `MenuTrigger`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `MenuTrigger`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `MenuTrigger`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `MenuTrigger`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `MenuTrigger`. -}
actionElementBase :
