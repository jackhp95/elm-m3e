module M3e.Build.NavRailToggle.Slots exposing
...
{-|
Slot setters for `M3e.Build.NavRailToggle`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.NavRailToggle.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `NavRailToggle`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `NavRailToggle`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `NavRailToggle`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `NavRailToggle`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `NavRailToggle`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `NavRailToggle`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `NavRailToggle`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `NavRailToggle`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `NavRailToggle`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `NavRailToggle`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `NavRailToggle`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `NavRailToggle`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `NavRailToggle`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `NavRailToggle`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `NavRailToggle`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `NavRailToggle`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `NavRailToggle`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `NavRailToggle`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `NavRailToggle`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `NavRailToggle`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `NavRailToggle`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `NavRailToggle`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `NavRailToggle`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `NavRailToggle`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `NavRailToggle`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `NavRailToggle`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `NavRailToggle`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `NavRailToggle`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `NavRailToggle`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `NavRailToggle`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `NavRailToggle`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `NavRailToggle`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `NavRailToggle`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `NavRailToggle`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `NavRailToggle`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `NavRailToggle`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `NavRailToggle`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `NavRailToggle`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `NavRailToggle`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `NavRailToggle`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `NavRailToggle`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `NavRailToggle`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `NavRailToggle`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `NavRailToggle`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `NavRailToggle`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `NavRailToggle`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `NavRailToggle`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `NavRailToggle`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `NavRailToggle`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `NavRailToggle`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `NavRailToggle`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `NavRailToggle`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `NavRailToggle`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `NavRailToggle`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `NavRailToggle`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `NavRailToggle`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `NavRailToggle`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `NavRailToggle`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `NavRailToggle`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `NavRailToggle`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `NavRailToggle`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `NavRailToggle`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `NavRailToggle`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `NavRailToggle`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `NavRailToggle`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `NavRailToggle`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `NavRailToggle`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `NavRailToggle`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `NavRailToggle`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `NavRailToggle`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `NavRailToggle`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `NavRailToggle`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `NavRailToggle`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `NavRailToggle`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `NavRailToggle`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `NavRailToggle`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `NavRailToggle`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `NavRailToggle`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `NavRailToggle`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `NavRailToggle`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `NavRailToggle`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `NavRailToggle`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `NavRailToggle`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `NavRailToggle`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `NavRailToggle`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `NavRailToggle`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `NavRailToggle`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `NavRailToggle`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `NavRailToggle`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `NavRailToggle`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `NavRailToggle`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `NavRailToggle`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `NavRailToggle`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `NavRailToggle`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `NavRailToggle`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `NavRailToggle`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `NavRailToggle`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `NavRailToggle`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `NavRailToggle`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `NavRailToggle`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `NavRailToggle`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `NavRailToggle`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `NavRailToggle`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `NavRailToggle`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `NavRailToggle`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `NavRailToggle`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `NavRailToggle`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `NavRailToggle`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `NavRailToggle`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `NavRailToggle`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `NavRailToggle`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `NavRailToggle`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `NavRailToggle`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `NavRailToggle`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `NavRailToggle`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `NavRailToggle`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `NavRailToggle`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `NavRailToggle`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `NavRailToggle`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `NavRailToggle`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `NavRailToggle`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `NavRailToggle`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `NavRailToggle`. -}
actionElementBase :
