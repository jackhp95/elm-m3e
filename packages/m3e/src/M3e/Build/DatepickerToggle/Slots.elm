module M3e.Build.DatepickerToggle.Slots exposing
...
{-|
Slot setters for `M3e.Build.DatepickerToggle`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
unnamed_core :
    ...
    -> M3e.Build.DatepickerToggle.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `DatepickerToggle`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `DatepickerToggle`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `DatepickerToggle`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `DatepickerToggle`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `DatepickerToggle`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `DatepickerToggle`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `DatepickerToggle`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `DatepickerToggle`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `DatepickerToggle`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `DatepickerToggle`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `DatepickerToggle`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `DatepickerToggle`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `DatepickerToggle`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `DatepickerToggle`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `DatepickerToggle`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `DatepickerToggle`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `DatepickerToggle`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `DatepickerToggle`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `DatepickerToggle`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `DatepickerToggle`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `DatepickerToggle`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `DatepickerToggle`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `DatepickerToggle`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `DatepickerToggle`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `DatepickerToggle`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `DatepickerToggle`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `DatepickerToggle`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `DatepickerToggle`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `DatepickerToggle`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `DatepickerToggle`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `DatepickerToggle`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `DatepickerToggle`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `DatepickerToggle`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `DatepickerToggle`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `DatepickerToggle`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `DatepickerToggle`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `DatepickerToggle`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `DatepickerToggle`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `DatepickerToggle`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `DatepickerToggle`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `DatepickerToggle`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `DatepickerToggle`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `DatepickerToggle`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `DatepickerToggle`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `DatepickerToggle`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `DatepickerToggle`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `DatepickerToggle`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `DatepickerToggle`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `DatepickerToggle`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `DatepickerToggle`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `DatepickerToggle`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `DatepickerToggle`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `DatepickerToggle`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `DatepickerToggle`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `DatepickerToggle`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `DatepickerToggle`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `DatepickerToggle`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `DatepickerToggle`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `DatepickerToggle`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `DatepickerToggle`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `DatepickerToggle`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `DatepickerToggle`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `DatepickerToggle`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `DatepickerToggle`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `DatepickerToggle`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `DatepickerToggle`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `DatepickerToggle`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `DatepickerToggle`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `DatepickerToggle`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `DatepickerToggle`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `DatepickerToggle`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `DatepickerToggle`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `DatepickerToggle`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `DatepickerToggle`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `DatepickerToggle`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `DatepickerToggle`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `DatepickerToggle`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `DatepickerToggle`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `DatepickerToggle`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `DatepickerToggle`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `DatepickerToggle`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `DatepickerToggle`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `DatepickerToggle`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `DatepickerToggle`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `DatepickerToggle`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `DatepickerToggle`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `DatepickerToggle`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `DatepickerToggle`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `DatepickerToggle`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `DatepickerToggle`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `DatepickerToggle`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `DatepickerToggle`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `DatepickerToggle`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `DatepickerToggle`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `DatepickerToggle`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `DatepickerToggle`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `DatepickerToggle`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `DatepickerToggle`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `DatepickerToggle`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `DatepickerToggle`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `DatepickerToggle`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `DatepickerToggle`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `DatepickerToggle`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `DatepickerToggle`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `DatepickerToggle`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `DatepickerToggle`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `DatepickerToggle`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `DatepickerToggle`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `DatepickerToggle`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `DatepickerToggle`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `DatepickerToggle`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `DatepickerToggle`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `DatepickerToggle`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `DatepickerToggle`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `DatepickerToggle`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `DatepickerToggle`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `DatepickerToggle`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `DatepickerToggle`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `DatepickerToggle`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `DatepickerToggle`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `DatepickerToggle`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `DatepickerToggle`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `DatepickerToggle`. -}
actionElementBase :
