module M3e.Build.Slide.Slots exposing
...
{-|
Slot setters for `M3e.Build.Slide`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
unnamed_core :
    ...
    -> M3e.Build.Slide.Builder pa ps msg pk
    -> M3e.Build.Slide.Builder pa ps msg pk
...
{-| Place a `Tree` in the `unnamed` slot of `Slide`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `Slide`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `Slide`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `Slide`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `Slide`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `Slide`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `Slide`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `Slide`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `Slide`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `Slide`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `Slide`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `Slide`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `Slide`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `Slide`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `Slide`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `Slide`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `Slide`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `Slide`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `Slide`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `Slide`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `Slide`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `Slide`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `Slide`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `Slide`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `Slide`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `Slide`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `Slide`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `Slide`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `Slide`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `Slide`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `Slide`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `Slide`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `Slide`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `Slide`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `Slide`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `Slide`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `Slide`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `Slide`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `Slide`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `Slide`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `Slide`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `Slide`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `Slide`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `Slide`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `Slide`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `Slide`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `Slide`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `Slide`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `Slide`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `Slide`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `Slide`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `Slide`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `Slide`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `Slide`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `Slide`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `Slide`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `Slide`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `Slide`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `Slide`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `Slide`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `Slide`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `Slide`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `Slide`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `Slide`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `Slide`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `Slide`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `Slide`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `Slide`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `Slide`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `Slide`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `Slide`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `Slide`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `Slide`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `Slide`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `Slide`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `Slide`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `Slide`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `Slide`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `Slide`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `Slide`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `Slide`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `Slide`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `Slide`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `Slide`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `Slide`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `Slide`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `Slide`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `Slide`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `Slide`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `Slide`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `Slide`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `Slide`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `Slide`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `Slide`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `Slide`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `Slide`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `Slide`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `Slide`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `Slide`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `Slide`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `Slide`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `Slide`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `Slide`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `Slide`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `Slide`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `Slide`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `Slide`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `Slide`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `Slide`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `Slide`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `Slide`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `Slide`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `Slide`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `Slide`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `Slide`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `Slide`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `Slide`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `Slide`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `Slide`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `Slide`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `Slide`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `Slide`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `Slide`. -}
actionElementBase :
