module M3e.Build.DialogTrigger.Slots exposing
...
{-|
Slot setters for `M3e.Build.DialogTrigger`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
default_core :
    ...
    -> M3e.Build.DialogTrigger.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `DialogTrigger`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `DialogTrigger`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `DialogTrigger`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `DialogTrigger`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `DialogTrigger`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `DialogTrigger`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `DialogTrigger`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `DialogTrigger`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `DialogTrigger`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `DialogTrigger`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `DialogTrigger`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `DialogTrigger`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `DialogTrigger`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `DialogTrigger`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `DialogTrigger`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `DialogTrigger`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `DialogTrigger`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `DialogTrigger`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `DialogTrigger`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `DialogTrigger`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `DialogTrigger`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `DialogTrigger`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `DialogTrigger`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `DialogTrigger`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `DialogTrigger`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `DialogTrigger`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `DialogTrigger`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `DialogTrigger`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `DialogTrigger`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `DialogTrigger`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `DialogTrigger`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `DialogTrigger`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `DialogTrigger`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `DialogTrigger`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `DialogTrigger`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `DialogTrigger`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `DialogTrigger`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `DialogTrigger`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `DialogTrigger`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `DialogTrigger`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `DialogTrigger`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `DialogTrigger`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `DialogTrigger`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `DialogTrigger`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `DialogTrigger`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `DialogTrigger`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `DialogTrigger`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `DialogTrigger`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `DialogTrigger`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `DialogTrigger`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `DialogTrigger`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `DialogTrigger`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `DialogTrigger`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `DialogTrigger`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `DialogTrigger`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `DialogTrigger`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `DialogTrigger`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `DialogTrigger`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `DialogTrigger`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `DialogTrigger`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `DialogTrigger`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `DialogTrigger`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `DialogTrigger`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `DialogTrigger`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `DialogTrigger`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `DialogTrigger`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `DialogTrigger`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `DialogTrigger`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `DialogTrigger`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `DialogTrigger`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `DialogTrigger`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `DialogTrigger`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `DialogTrigger`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `DialogTrigger`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `DialogTrigger`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `DialogTrigger`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `DialogTrigger`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `DialogTrigger`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `DialogTrigger`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `DialogTrigger`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `DialogTrigger`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `DialogTrigger`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `DialogTrigger`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `DialogTrigger`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `DialogTrigger`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `DialogTrigger`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `DialogTrigger`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `DialogTrigger`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `DialogTrigger`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `DialogTrigger`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `DialogTrigger`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `DialogTrigger`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `DialogTrigger`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `DialogTrigger`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `DialogTrigger`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `DialogTrigger`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `DialogTrigger`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `DialogTrigger`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `DialogTrigger`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `DialogTrigger`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `DialogTrigger`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `DialogTrigger`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `DialogTrigger`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `DialogTrigger`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `DialogTrigger`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `DialogTrigger`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `DialogTrigger`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `DialogTrigger`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `DialogTrigger`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `DialogTrigger`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `DialogTrigger`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `DialogTrigger`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `DialogTrigger`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `DialogTrigger`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `DialogTrigger`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `DialogTrigger`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `DialogTrigger`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `DialogTrigger`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `DialogTrigger`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `DialogTrigger`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `DialogTrigger`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `DialogTrigger`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `DialogTrigger`. -}
actionElementBase :
