module M3e.Build.DialogAction.Slots exposing
...
unnamed_core :
    ...
    -> M3e.Build.DialogAction.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `DialogAction`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `DialogAction`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `DialogAction`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `DialogAction`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `DialogAction`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `DialogAction`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `DialogAction`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `DialogAction`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `DialogAction`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `DialogAction`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `DialogAction`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `DialogAction`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `DialogAction`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `DialogAction`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `DialogAction`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `DialogAction`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `DialogAction`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `DialogAction`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `DialogAction`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `DialogAction`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `DialogAction`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `DialogAction`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `DialogAction`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `DialogAction`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `DialogAction`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `DialogAction`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `DialogAction`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `DialogAction`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `DialogAction`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `DialogAction`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `DialogAction`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `DialogAction`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `DialogAction`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `DialogAction`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `DialogAction`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `DialogAction`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `DialogAction`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `DialogAction`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `DialogAction`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `DialogAction`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `DialogAction`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `DialogAction`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `DialogAction`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `DialogAction`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `DialogAction`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `DialogAction`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `DialogAction`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `DialogAction`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `DialogAction`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `DialogAction`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `DialogAction`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `DialogAction`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `DialogAction`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `DialogAction`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `DialogAction`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `DialogAction`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `DialogAction`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `DialogAction`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `DialogAction`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `DialogAction`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `DialogAction`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `DialogAction`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `DialogAction`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `DialogAction`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `DialogAction`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `DialogAction`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `DialogAction`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `DialogAction`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `DialogAction`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `DialogAction`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `DialogAction`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `DialogAction`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `DialogAction`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `DialogAction`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `DialogAction`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `DialogAction`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `DialogAction`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `DialogAction`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `DialogAction`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `DialogAction`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `DialogAction`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `DialogAction`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `DialogAction`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `DialogAction`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `DialogAction`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `DialogAction`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `DialogAction`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `DialogAction`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `DialogAction`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `DialogAction`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `DialogAction`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `DialogAction`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `DialogAction`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `DialogAction`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `DialogAction`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `DialogAction`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `DialogAction`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `DialogAction`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `DialogAction`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `DialogAction`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `DialogAction`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `DialogAction`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `DialogAction`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `DialogAction`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `DialogAction`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `DialogAction`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `DialogAction`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `DialogAction`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `DialogAction`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `DialogAction`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `DialogAction`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `DialogAction`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `DialogAction`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `DialogAction`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `DialogAction`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `DialogAction`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `DialogAction`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `DialogAction`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `DialogAction`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `DialogAction`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `DialogAction`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `DialogAction`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `DialogAction`. -}
actionElementBase :
