module M3e.Build.RadioGroup.Slots exposing
...
default_core :
    ...
    -> M3e.Build.RadioGroup.Builder pa { ps | default : filled } msg pk
    -> M3e.Build.RadioGroup.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `RadioGroup`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `RadioGroup`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `RadioGroup`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `RadioGroup`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `RadioGroup`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `RadioGroup`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `RadioGroup`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `RadioGroup`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `RadioGroup`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `RadioGroup`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `RadioGroup`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `RadioGroup`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `RadioGroup`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `RadioGroup`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `RadioGroup`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `RadioGroup`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `RadioGroup`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `RadioGroup`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `RadioGroup`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `RadioGroup`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `RadioGroup`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `RadioGroup`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `RadioGroup`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `RadioGroup`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `RadioGroup`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `RadioGroup`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `RadioGroup`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `RadioGroup`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `RadioGroup`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `RadioGroup`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `RadioGroup`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `RadioGroup`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `RadioGroup`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `RadioGroup`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `RadioGroup`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `RadioGroup`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `RadioGroup`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `RadioGroup`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `RadioGroup`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `RadioGroup`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `RadioGroup`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `RadioGroup`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `RadioGroup`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `RadioGroup`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `RadioGroup`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `RadioGroup`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `RadioGroup`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `RadioGroup`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `RadioGroup`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `RadioGroup`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `RadioGroup`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `RadioGroup`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `RadioGroup`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `RadioGroup`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `RadioGroup`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `RadioGroup`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `RadioGroup`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `RadioGroup`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `RadioGroup`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `RadioGroup`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `RadioGroup`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `RadioGroup`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `RadioGroup`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `RadioGroup`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `RadioGroup`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `RadioGroup`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `RadioGroup`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `RadioGroup`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `RadioGroup`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `RadioGroup`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `RadioGroup`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `RadioGroup`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `RadioGroup`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `RadioGroup`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `RadioGroup`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `RadioGroup`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `RadioGroup`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `RadioGroup`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `RadioGroup`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `RadioGroup`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `RadioGroup`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `RadioGroup`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `RadioGroup`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `RadioGroup`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `RadioGroup`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `RadioGroup`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `RadioGroup`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `RadioGroup`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `RadioGroup`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `RadioGroup`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `RadioGroup`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `RadioGroup`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `RadioGroup`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `RadioGroup`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `RadioGroup`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `RadioGroup`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `RadioGroup`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `RadioGroup`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `RadioGroup`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `RadioGroup`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `RadioGroup`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `RadioGroup`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `RadioGroup`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `RadioGroup`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `RadioGroup`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `RadioGroup`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `RadioGroup`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `RadioGroup`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `RadioGroup`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `RadioGroup`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `RadioGroup`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `RadioGroup`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `RadioGroup`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `RadioGroup`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `RadioGroup`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `RadioGroup`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `RadioGroup`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `RadioGroup`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `RadioGroup`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `RadioGroup`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `RadioGroup`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `RadioGroup`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `RadioGroup`. -}
actionElementBase :
