module M3e.Build.Collapsible.Slots exposing
...
{-| Place a `Tree` in the `unnamed` slot of `Collapsible`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `Collapsible`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `Collapsible`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `Collapsible`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `Collapsible`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `Collapsible`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `Collapsible`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `Collapsible`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `Collapsible`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `Collapsible`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `Collapsible`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `Collapsible`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `Collapsible`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `Collapsible`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `Collapsible`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `Collapsible`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `Collapsible`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `Collapsible`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `Collapsible`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `Collapsible`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `Collapsible`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `Collapsible`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `Collapsible`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `Collapsible`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `Collapsible`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `Collapsible`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `Collapsible`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `Collapsible`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `Collapsible`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `Collapsible`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `Collapsible`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `Collapsible`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `Collapsible`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `Collapsible`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `Collapsible`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `Collapsible`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `Collapsible`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `Collapsible`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `Collapsible`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `Collapsible`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `Collapsible`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `Collapsible`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `Collapsible`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `Collapsible`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `Collapsible`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `Collapsible`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `Collapsible`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `Collapsible`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `Collapsible`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `Collapsible`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `Collapsible`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `Collapsible`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `Collapsible`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `Collapsible`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `Collapsible`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `Collapsible`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `Collapsible`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `Collapsible`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `Collapsible`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `Collapsible`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `Collapsible`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `Collapsible`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `Collapsible`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `Collapsible`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `Collapsible`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `Collapsible`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `Collapsible`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `Collapsible`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `Collapsible`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `Collapsible`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `Collapsible`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `Collapsible`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `Collapsible`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `Collapsible`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `Collapsible`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `Collapsible`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `Collapsible`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `Collapsible`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `Collapsible`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `Collapsible`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `Collapsible`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `Collapsible`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `Collapsible`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `Collapsible`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `Collapsible`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `Collapsible`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `Collapsible`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `Collapsible`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `Collapsible`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `Collapsible`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `Collapsible`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `Collapsible`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `Collapsible`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `Collapsible`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `Collapsible`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `Collapsible`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `Collapsible`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `Collapsible`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `Collapsible`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `Collapsible`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `Collapsible`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `Collapsible`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `Collapsible`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `Collapsible`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `Collapsible`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `Collapsible`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `Collapsible`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `Collapsible`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `Collapsible`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `Collapsible`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `Collapsible`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `Collapsible`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `Collapsible`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `Collapsible`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `Collapsible`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `Collapsible`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `Collapsible`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `Collapsible`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `Collapsible`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `Collapsible`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `Collapsible`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `Collapsible`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `Collapsible`. -}
actionElementBase :
