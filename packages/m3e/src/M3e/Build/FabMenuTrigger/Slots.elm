module M3e.Build.FabMenuTrigger.Slots exposing
...
{-|
Slot setters for `M3e.Build.FabMenuTrigger`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
unnamed_core :
    ...
    -> M3e.Build.FabMenuTrigger.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `FabMenuTrigger`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `FabMenuTrigger`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `FabMenuTrigger`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `FabMenuTrigger`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `FabMenuTrigger`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `FabMenuTrigger`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `FabMenuTrigger`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `FabMenuTrigger`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `FabMenuTrigger`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `FabMenuTrigger`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `FabMenuTrigger`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `FabMenuTrigger`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `FabMenuTrigger`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `FabMenuTrigger`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `FabMenuTrigger`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `FabMenuTrigger`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `FabMenuTrigger`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `FabMenuTrigger`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `FabMenuTrigger`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `FabMenuTrigger`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `FabMenuTrigger`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `FabMenuTrigger`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `FabMenuTrigger`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `FabMenuTrigger`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `FabMenuTrigger`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `FabMenuTrigger`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `FabMenuTrigger`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `FabMenuTrigger`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `FabMenuTrigger`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `FabMenuTrigger`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `FabMenuTrigger`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `FabMenuTrigger`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `FabMenuTrigger`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `FabMenuTrigger`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `FabMenuTrigger`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `FabMenuTrigger`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `FabMenuTrigger`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `FabMenuTrigger`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `FabMenuTrigger`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `FabMenuTrigger`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `FabMenuTrigger`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `FabMenuTrigger`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `FabMenuTrigger`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `FabMenuTrigger`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `FabMenuTrigger`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `FabMenuTrigger`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `FabMenuTrigger`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `FabMenuTrigger`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `FabMenuTrigger`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `FabMenuTrigger`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `FabMenuTrigger`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `FabMenuTrigger`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `FabMenuTrigger`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `FabMenuTrigger`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `FabMenuTrigger`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `FabMenuTrigger`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `FabMenuTrigger`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `FabMenuTrigger`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `FabMenuTrigger`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `FabMenuTrigger`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `FabMenuTrigger`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `FabMenuTrigger`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `FabMenuTrigger`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `FabMenuTrigger`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `FabMenuTrigger`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `FabMenuTrigger`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `FabMenuTrigger`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `FabMenuTrigger`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `FabMenuTrigger`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `FabMenuTrigger`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `FabMenuTrigger`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `FabMenuTrigger`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `FabMenuTrigger`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `FabMenuTrigger`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `FabMenuTrigger`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `FabMenuTrigger`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `FabMenuTrigger`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `FabMenuTrigger`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `FabMenuTrigger`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `FabMenuTrigger`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `FabMenuTrigger`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `FabMenuTrigger`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `FabMenuTrigger`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `FabMenuTrigger`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `FabMenuTrigger`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `FabMenuTrigger`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `FabMenuTrigger`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `FabMenuTrigger`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `FabMenuTrigger`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `FabMenuTrigger`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `FabMenuTrigger`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `FabMenuTrigger`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `FabMenuTrigger`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `FabMenuTrigger`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `FabMenuTrigger`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `FabMenuTrigger`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `FabMenuTrigger`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `FabMenuTrigger`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `FabMenuTrigger`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `FabMenuTrigger`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `FabMenuTrigger`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `FabMenuTrigger`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `FabMenuTrigger`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `FabMenuTrigger`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `FabMenuTrigger`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `FabMenuTrigger`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `FabMenuTrigger`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `FabMenuTrigger`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `FabMenuTrigger`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `FabMenuTrigger`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `FabMenuTrigger`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `FabMenuTrigger`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `FabMenuTrigger`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `FabMenuTrigger`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `FabMenuTrigger`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `FabMenuTrigger`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `FabMenuTrigger`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `FabMenuTrigger`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `FabMenuTrigger`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `FabMenuTrigger`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `FabMenuTrigger`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `FabMenuTrigger`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `FabMenuTrigger`. -}
actionElementBase :
