module M3e.Build.DrawerToggle.Slots exposing
...
{-|
Slot setters for `M3e.Build.DrawerToggle`. Each alias accepts a specific child component's Builder and inserts it into the parent's slot.
...
unnamed_core :
    ...
    -> M3e.Build.DrawerToggle.Builder pa { ps
...
{-| Place a `Tree` in the `unnamed` slot of `DrawerToggle`. -}
tree :
...
{-| Place a `TreeItem` in the `unnamed` slot of `DrawerToggle`. -}
treeItem :
...
{-| Place a `Toolbar` in the `unnamed` slot of `DrawerToggle`. -}
toolbar :
...
{-| Place a `Toc` in the `unnamed` slot of `DrawerToggle`. -}
toc :
...
{-| Place a `TocItem` in the `unnamed` slot of `DrawerToggle`. -}
tocItem :
...
{-| Place a `ThemeIcon` in the `unnamed` slot of `DrawerToggle`. -}
themeIcon :
...
{-| Place a `Theme` in the `unnamed` slot of `DrawerToggle`. -}
theme :
...
{-| Place a `TextareaAutosize` in the `unnamed` slot of `DrawerToggle`. -}
textareaAutosize :
...
{-| Place a `Tabs` in the `unnamed` slot of `DrawerToggle`. -}
tabs :
...
{-| Place a `TabPanel` in the `unnamed` slot of `DrawerToggle`. -}
tabPanel :
...
{-| Place a `Tab` in the `unnamed` slot of `DrawerToggle`. -}
tab :
...
{-| Place a `Switch` in the `unnamed` slot of `DrawerToggle`. -}
switch :
...
{-| Place a `StepperReset` in the `unnamed` slot of `DrawerToggle`. -}
stepperReset :
...
{-| Place a `StepperPrevious` in the `unnamed` slot of `DrawerToggle`. -}
stepperPrevious :
...
{-| Place a `Step` in the `unnamed` slot of `DrawerToggle`. -}
step :
...
{-| Place a `StepPanel` in the `unnamed` slot of `DrawerToggle`. -}
stepPanel :
...
{-| Place a `Stepper` in the `unnamed` slot of `DrawerToggle`. -}
stepper :
...
{-| Place a `SplitPane` in the `unnamed` slot of `DrawerToggle`. -}
splitPane :
...
{-| Place a `SplitButton` in the `unnamed` slot of `DrawerToggle`. -}
splitButton :
...
{-| Place a `Snackbar` in the `unnamed` slot of `DrawerToggle`. -}
snackbar :
...
{-| Place a `Slider` in the `unnamed` slot of `DrawerToggle`. -}
slider :
...
{-| Place a `SliderThumb` in the `unnamed` slot of `DrawerToggle`. -}
sliderThumb :
...
{-| Place a `SlideGroup` in the `unnamed` slot of `DrawerToggle`. -}
slideGroup :
...
{-| Place a `Skeleton` in the `unnamed` slot of `DrawerToggle`. -}
skeleton :
...
{-| Place a `Shape` in the `unnamed` slot of `DrawerToggle`. -}
shape :
...
{-| Place a `SegmentedButton` in the `unnamed` slot of `DrawerToggle`. -}
segmentedButton :
...
{-| Place a `ButtonSegment` in the `unnamed` slot of `DrawerToggle`. -}
buttonSegment :
...
{-| Place a `SearchView` in the `unnamed` slot of `DrawerToggle`. -}
searchView :
...
{-| Place a `SearchBar` in the `unnamed` slot of `DrawerToggle`. -}
searchBar :
...
{-| Place a `RadioGroup` in the `unnamed` slot of `DrawerToggle`. -}
radioGroup :
...
{-| Place a `Radio` in the `unnamed` slot of `DrawerToggle`. -}
radio :
...
{-| Place a `ProgressElementIndicatorBase` in the `unnamed` slot of `DrawerToggle`. -}
...
{-| Place a `Paginator` in the `unnamed` slot of `DrawerToggle`. -}
paginator :
...
{-| Place a `Select` in the `unnamed` slot of `DrawerToggle`. -}
select :
...
{-| Place a `NavRailToggle` in the `unnamed` slot of `DrawerToggle`. -}
navRailToggle :
...
{-| Place a `NavRail` in the `unnamed` slot of `DrawerToggle`. -}
navRail :
...
{-| Place a `NavMenuItemGroup` in the `unnamed` slot of `DrawerToggle`. -}
navMenuItemGroup :
...
{-| Place a `NavMenu` in the `unnamed` slot of `DrawerToggle`. -}
navMenu :
...
{-| Place a `NavMenuItem` in the `unnamed` slot of `DrawerToggle`. -}
navMenuItem :
...
{-| Place a `NavBar` in the `unnamed` slot of `DrawerToggle`. -}
navBar :
...
{-| Place a `NavItem` in the `unnamed` slot of `DrawerToggle`. -}
navItem :
...
{-| Place a `MenuItemRadio` in the `unnamed` slot of `DrawerToggle`. -}
menuItemRadio :
...
{-| Place a `MenuItemGroup` in the `unnamed` slot of `DrawerToggle`. -}
menuItemGroup :
...
{-| Place a `MenuItemCheckbox` in the `unnamed` slot of `DrawerToggle`. -}
menuItemCheckbox :
...
{-| Place a `Menu` in the `unnamed` slot of `DrawerToggle`. -}
menu :
...
{-| Place a `MenuItem` in the `unnamed` slot of `DrawerToggle`. -}
menuItem :
...
{-| Place a `MenuTrigger` in the `unnamed` slot of `DrawerToggle`. -}
menuTrigger :
...
{-| Place a `MenuItemElementBase` in the `unnamed` slot of `DrawerToggle`. -}
menuItemElementBase :
...
{-| Place a `LoadingIndicator` in the `unnamed` slot of `DrawerToggle`. -}
loadingIndicator :
...
{-| Place a `SelectionList` in the `unnamed` slot of `DrawerToggle`. -}
selectionList :
...
{-| Place a `ListOption` in the `unnamed` slot of `DrawerToggle`. -}
listOption :
...
{-| Place a `ActionList` in the `unnamed` slot of `DrawerToggle`. -}
actionList :
...
{-| Place a `ExpandableListItem` in the `unnamed` slot of `DrawerToggle`. -}
expandableListItem :
...
{-| Place a `ListAction` in the `unnamed` slot of `DrawerToggle`. -}
listAction :
...
{-| Place a `ListItemButton` in the `unnamed` slot of `DrawerToggle`. -}
listItemButton :
...
{-| Place a `List` in the `unnamed` slot of `DrawerToggle`. -}
list :
...
{-| Place a `ListItem` in the `unnamed` slot of `DrawerToggle`. -}
listItem :
...
{-| Place a `Icon` in the `unnamed` slot of `DrawerToggle`. -}
icon :
...
{-| Place a `Heading` in the `unnamed` slot of `DrawerToggle`. -}
heading :
...
{-| Place a `FabMenuTrigger` in the `unnamed` slot of `DrawerToggle`. -}
fabMenuTrigger :
...
{-| Place a `FabMenu` in the `unnamed` slot of `DrawerToggle`. -}
fabMenu :
...
{-| Place a `Fab` in the `unnamed` slot of `DrawerToggle`. -}
fab :
...
{-| Place a `Accordion` in the `unnamed` slot of `DrawerToggle`. -}
accordion :
...
{-| Place a `ExpansionPanel` in the `unnamed` slot of `DrawerToggle`. -}
expansionPanel :
...
{-| Place a `ExpansionHeader` in the `unnamed` slot of `DrawerToggle`. -}
expansionHeader :
...
{-| Place a `DrawerToggle` in the `unnamed` slot of `DrawerToggle`. -}
drawerToggle :
...
{-| Place a `DrawerContainer` in the `unnamed` slot of `DrawerToggle`. -}
drawerContainer :
...
{-| Place a `Divider` in the `unnamed` slot of `DrawerToggle`. -}
divider :
...
{-| Place a `DialogTrigger` in the `unnamed` slot of `DrawerToggle`. -}
dialogTrigger :
...
{-| Place a `Dialog` in the `unnamed` slot of `DrawerToggle`. -}
dialog :
...
{-| Place a `DialogAction` in the `unnamed` slot of `DrawerToggle`. -}
dialogAction :
...
{-| Place a `DatepickerToggle` in the `unnamed` slot of `DrawerToggle`. -}
datepickerToggle :
...
{-| Place a `Datepicker` in the `unnamed` slot of `DrawerToggle`. -}
datepicker :
...
{-| Place a `ContentPane` in the `unnamed` slot of `DrawerToggle`. -}
contentPane :
...
{-| Place a `SuggestionChip` in the `unnamed` slot of `DrawerToggle`. -}
suggestionChip :
...
{-| Place a `InputChipSet` in the `unnamed` slot of `DrawerToggle`. -}
inputChipSet :
...
{-| Place a `InputChip` in the `unnamed` slot of `DrawerToggle`. -}
inputChip :
...
{-| Place a `FilterChipSet` in the `unnamed` slot of `DrawerToggle`. -}
filterChipSet :
...
{-| Place a `FilterChip` in the `unnamed` slot of `DrawerToggle`. -}
filterChip :
...
{-| Place a `ChipSet` in the `unnamed` slot of `DrawerToggle`. -}
chipSet :
...
{-| Place a `AssistChip` in the `unnamed` slot of `DrawerToggle`. -}
assistChip :
...
{-| Place a `Chip` in the `unnamed` slot of `DrawerToggle`. -}
chip :
...
{-| Place a `Checkbox` in the `unnamed` slot of `DrawerToggle`. -}
checkbox :
...
{-| Place a `Card` in the `unnamed` slot of `DrawerToggle`. -}
card :
...
{-| Place a `Calendar` in the `unnamed` slot of `DrawerToggle`. -}
calendar :
...
{-| Place a `YearView` in the `unnamed` slot of `DrawerToggle`. -}
yearView :
...
{-| Place a `MultiYearView` in the `unnamed` slot of `DrawerToggle`. -}
multiYearView :
...
{-| Place a `MonthView` in the `unnamed` slot of `DrawerToggle`. -}
monthView :
...
{-| Place a `Tooltip` in the `unnamed` slot of `DrawerToggle`. -}
tooltip :
...
{-| Place a `RichTooltip` in the `unnamed` slot of `DrawerToggle`. -}
richTooltip :
...
{-| Place a `TooltipElementBase` in the `unnamed` slot of `DrawerToggle`. -}
tooltipElementBase :
...
{-| Place a `RichTooltipAction` in the `unnamed` slot of `DrawerToggle`. -}
richTooltipAction :
...
{-| Place a `ButtonGroup` in the `unnamed` slot of `DrawerToggle`. -}
buttonGroup :
...
{-| Place a `IconButton` in the `unnamed` slot of `DrawerToggle`. -}
iconButton :
...
{-| Place a `Button` in the `unnamed` slot of `DrawerToggle`. -}
button :
...
{-| Place a `Breadcrumb` in the `unnamed` slot of `DrawerToggle`. -}
breadcrumb :
...
{-| Place a `BreadcrumbItem` in the `unnamed` slot of `DrawerToggle`. -}
breadcrumbItem :
...
{-| Place a `BreadcrumbItemButton` in the `unnamed` slot of `DrawerToggle`. -}
...
{-| Place a `BottomSheetTrigger` in the `unnamed` slot of `DrawerToggle`. -}
bottomSheetTrigger :
...
{-| Place a `BottomSheet` in the `unnamed` slot of `DrawerToggle`. -}
bottomSheet :
...
{-| Place a `BottomSheetAction` in the `unnamed` slot of `DrawerToggle`. -}
bottomSheetAction :
...
{-| Place a `Badge` in the `unnamed` slot of `DrawerToggle`. -}
badge :
...
{-| Place a `Avatar` in the `unnamed` slot of `DrawerToggle`. -}
avatar :
...
{-| Place a `Autocomplete` in the `unnamed` slot of `DrawerToggle`. -}
autocomplete :
...
{-| Place a `FormField` in the `unnamed` slot of `DrawerToggle`. -}
formField :
...
{-| Place a `OptionPanel` in the `unnamed` slot of `DrawerToggle`. -}
optionPanel :
...
{-| Place a `FloatingPanel` in the `unnamed` slot of `DrawerToggle`. -}
floatingPanel :
...
{-| Place a `Optgroup` in the `unnamed` slot of `DrawerToggle`. -}
optgroup :
...
{-| Place a `Option` in the `unnamed` slot of `DrawerToggle`. -}
option :
...
{-| Place a `FocusTrap` in the `unnamed` slot of `DrawerToggle`. -}
focusTrap :
...
{-| Place a `AppBar` in the `unnamed` slot of `DrawerToggle`. -}
appBar :
...
{-| Place a `TextOverflow` in the `unnamed` slot of `DrawerToggle`. -}
textOverflow :
...
{-| Place a `TextHighlight` in the `unnamed` slot of `DrawerToggle`. -}
textHighlight :
...
{-| Place a `StateLayer` in the `unnamed` slot of `DrawerToggle`. -}
stateLayer :
...
{-| Place a `Slide` in the `unnamed` slot of `DrawerToggle`. -}
slide :
...
{-| Place a `ScrollContainer` in the `unnamed` slot of `DrawerToggle`. -}
scrollContainer :
...
{-| Place a `Ripple` in the `unnamed` slot of `DrawerToggle`. -}
ripple :
...
{-| Place a `PseudoRadio` in the `unnamed` slot of `DrawerToggle`. -}
pseudoRadio :
...
{-| Place a `PseudoCheckbox` in the `unnamed` slot of `DrawerToggle`. -}
pseudoCheckbox :
...
{-| Place a `FocusRing` in the `unnamed` slot of `DrawerToggle`. -}
focusRing :
...
{-| Place a `Elevation` in the `unnamed` slot of `DrawerToggle`. -}
elevation :
...
{-| Place a `Collapsible` in the `unnamed` slot of `DrawerToggle`. -}
collapsible :
...
{-| Place a `ActionElementBase` in the `unnamed` slot of `DrawerToggle`. -}
actionElementBase :
