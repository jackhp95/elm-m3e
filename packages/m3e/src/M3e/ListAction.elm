module M3e.ListAction exposing (child, children, disabled, download, href, leading, listAction, onClick, overline, rel, supportingText, target, trailing)

{-| 
@docs listAction, disabled, download, href, rel, target, onClick, child, leading, overline, supportingText, trailing, children
-}
...
listAction attributes content_ =
