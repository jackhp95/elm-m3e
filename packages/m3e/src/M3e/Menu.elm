...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu1" ] [ Kit.text "Menu" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ Kit.text "Item 1" ], M3e.MenuItem.view [] [ Kit.text "Item 2" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "vmenu1" ] [ Kit.text "Vibrant menu" ] ]
    , M3e.Menu.view [ M3e.Menu.variant M3e.Value.vibrant ] [ M3e.MenuItem.view [] [ Kit.text "Item 1" ], M3e.MenuItem.view [] [ Kit.text "Item 2" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu8" ] [ Kit.text "Menu items with icons" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "dialpad" ] []), Kit.text "Redial" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "voicemail" ] []), Kit.text "Check voice mail" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "notifications_off" ] []), Kit.text "Disable alerts" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu9" ] [ Kit.text "Menu with disabled items" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [ M3e.MenuItem.disabled True ] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "dialpad" ] []), Kit.text "Redial" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "voicemail" ] []), Kit.text "Check voice mail" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "notifications_off" ] []), Kit.text "Disable alerts" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu2" ] [ Kit.text "Menu with checkboxes" ] ]
    , M3e.Menu.view [] [ M3e.MenuItemCheckbox.view [ M3e.MenuItemCheckbox.checked True ] [ M3e.MenuItemCheckbox.icon (M3e.Icon.view [ M3e.Icon.name "format_bold" ] []), Kit.text "Bold" ], M3e.MenuItemCheckbox.view [] [ M3e.MenuItemCheckbox.icon (M3e.Icon.view [ M3e.Icon.name "format_italic" ] []), Kit.text "Italic" ], M3e.MenuItemCheckbox.view [] [ M3e.MenuItemCheckbox.icon (M3e.Icon.view [ M3e.Icon.name "format_underlined" ] []), Kit.text "Underline" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu3" ] [ Kit.text "Menu with radios" ] ]
    , M3e.Menu.view [] [ M3e.MenuItemRadio.view [ M3e.MenuItemRadio.checked True ] [ Kit.text "Ascending" ], M3e.MenuItemRadio.view [] [ Kit.text "Descending" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu4" ] [ Kit.text "Menu with radio groups" ] ]
    , M3e.Menu.view [] [ M3e.MenuItemGroup.view [] [ M3e.MenuItemRadio.view [ M3e.MenuItemRadio.checked True ] [ Kit.text "Ascending" ], M3e.MenuItemRadio.view [] [ Kit.text "Descending" ] ], M3e.Divider.view [] [], M3e.MenuItemGroup.view [] [ M3e.MenuItemRadio.view [ M3e.MenuItemRadio.checked True ] [ Kit.text "Alphabetical" ], M3e.MenuItemRadio.view [] [ Kit.text "By Date" ] ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu5" ] [ Kit.text "Menu with submenus" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu6" ] [ Kit.text "Fruits with A" ] ], M3e.MenuItem.view [] [ Kit.text "Grapes" ], M3e.MenuItem.view [] [ Kit.text "Olive" ], M3e.MenuItem.view [] [ Kit.text "Orange" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ Kit.text "Apricot" ], M3e.MenuItem.view [] [ Kit.text "Avocado" ], M3e.MenuItem.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu7" ] [ Kit.text "Apples" ] ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ Kit.text "Fuji" ], M3e.MenuItem.view [] [ Kit.text "Granny Smith" ], M3e.MenuItem.view [] [ Kit.text "Red Delicious" ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.MenuTrigger.view [ M3e.MenuTrigger.for "menu-density-3" ] [ Kit.text "Density -3" ] ]
    , M3e.Menu.view [] [ M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "Item 1" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "Item 2" ], M3e.MenuItem.view [] [ M3e.MenuItem.icon (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "Item 3" ] ]
