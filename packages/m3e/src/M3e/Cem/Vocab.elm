...
name =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.name
...
pageSize =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.pageSize
...
value =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.value
