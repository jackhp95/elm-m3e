module M3e.Cem.Vocab exposing
    ...
    , length, linear, loaded, loading, loadingLabel, lowered, max
    , maxDate, maxDepth, maxRows, min, minDate, minRows, modal
    , mode, motion, multi, nextMonthLabel, nextMultiYearLabel, nextPageLabel, nextYearLabel
    , noAnimate, noDataLabel, noFocusTrap, open, opticalSize, optional, orientation
    , overshootLimit, pageIndex, pageSize, pageSizeVariant, pageSizes, panelClass, position
    , positionX, positionY, previousMonthLabel, previousMultiYearLabel, previousPageLabel, previousYearLabel, radius
    , range, rangeEnd, rangeStart, rel, removable, removeLabel, required
    , returnValue, scheme, scrollStrategy, secondary, selected, selectedIndex, shape
    , showDelay, showFirstLastButtons, size, start, startAt, startDivider, startMode
    , startView, state, step, stretch, strongFocus, submenu, target
    , term, thin, threshold, today, toggle, toggleDirection, togglePosition
    , touchGestures, type_, unbounded, variant, vertical, weight, width
...
@docs modal, mode, motion, multi, nextMonthLabel, nextMultiYearLabel
@docs nextPageLabel, nextYearLabel, noAnimate, noDataLabel, noFocusTrap, open
@docs opticalSize, optional, orientation, overshootLimit, pageIndex, pageSize
@docs pageSizeVariant, pageSizes, panelClass, position, positionX, positionY
@docs previousMonthLabel, previousMultiYearLabel, previousPageLabel, previousYearLabel, radius, range
@docs rangeEnd, rangeStart, rel, removable, removeLabel, required
@docs returnValue, scheme, scrollStrategy, secondary, selected, selectedIndex
@docs shape, showDelay, showFirstLastButtons, size, start, startAt
@docs startDivider, startMode, startView, state, step, stretch
@docs strongFocus, submenu, target, term, thin, threshold
@docs today, toggle, toggleDirection, togglePosition, touchGestures, type_
@docs unbounded, variant, vertical, weight, width, wrap
...
action =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.action
...
anchorOffset =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.anchorOffset
...
animation v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.animation (M3e.Value.toString v_)
...
ariaInvalid =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.ariaInvalid
...
autoActivate =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.autoActivate
...
bufferValue =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.bufferValue
...
cascade =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.cascade
...
caseSensitive =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.caseSensitive
...
centered =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.centered


{-| Whether the element is checked. (default: `false`) -}
checked : Bool -> M3e.Cem.Attr.Attr { c | checked : M3e.Value.Supported } msg
checked =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.checked
...
clearLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.clearLabel
...
clearable =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.clearable
...
completed =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.completed
...
confirmLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.confirmLabel
...
contained =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.contained
...
contrast v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.contrast (M3e.Value.toString v_)
...
current v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.current (M3e.Value.toString v_)


{-| The selected date. (default: `null`) -}
date : String -> M3e.Cem.Attr.Attr { c | date : M3e.Value.Supported } msg
date =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.date


{-| The density scale (0, -1, -2). (default: `0`) -}
density : Float -> M3e.Cem.Attr.Attr { c | density : M3e.Value.Supported } msg
density =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.density
...
detent =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.detent
...
disableClose =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disableClose
...
disableHighlight =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disableHighlight
...
disableHover =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disableHover
...
disableRestoreFocus =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disableRestoreFocus


{-| Whether the element is disabled. (default: `false`) -}
disabled : Bool -> M3e.Cem.Attr.Attr { c | disabled : M3e.Value.Supported } msg
disabled =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disabled
...
disabledInteractive =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.disabledInteractive


{-| Whether to show tick marks. (default: `false`) -}
discrete : Bool -> M3e.Cem.Attr.Attr { c | discrete : M3e.Value.Supported } msg
discrete =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.discrete
...
dismissLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.dismissLabel
...
dismissible =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.dismissible
...
dividers v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.dividers (M3e.Value.toString v_)
...
download =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.download
...
duration =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.duration
...
endDivider =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.endDivider
...
endMode v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.endMode (M3e.Value.toString v_)
...
filter v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.filter (M3e.Value.toString v_)
...
firstPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.firstPageLabel
...
fitAnchorWidth =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.fitAnchorWidth
...
floatLabel v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.floatLabel (M3e.Value.toString v_)


{-| The identifier of the interactive control to which this element is attached. (default: `null`) -}
for : String -> M3e.Cem.Attr.Attr { c | for : M3e.Value.Supported } msg
for =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.for
...
grade v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.grade (M3e.Value.toString v_)
...
handle =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.handle
...
handleLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.handleLabel
...
hideDelay =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideDelay
...
hideFriction =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideFriction
...
hideLoading =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideLoading
...
hideNoData =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideNoData
...
hidePageSize =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hidePageSize
...
hideRequiredMarker =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideRequiredMarker
...
hideSearchIcon =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideSearchIcon
...
hideSelectionIndicator =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideSelectionIndicator
...
hideToggle =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideToggle
...
hideable =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.hideable
...
href =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.href
...
icons v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.icons (M3e.Value.toString v_)
...
indeterminate =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.indeterminate
...
inline =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.inline
...
inset =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.inset
...
insetEnd =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.insetEnd
...
inward =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.inward
...
itemLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.itemLabel
...
itemsPerPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.itemsPerPageLabel
...
label =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.label
...
labelled =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.labelled
...
lastPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.lastPageLabel
...
length =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.length
...
linear =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.linear
...
mode v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.mode (M3e.Value.toString v_)
...
motion v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.motion (M3e.Value.toString v_)


{-| Whether multiple items can be selected. (default: `false`) -}
multi : Bool -> M3e.Cem.Attr.Attr { c | multi : M3e.Value.Supported } msg
multi =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.multi
...
nextMonthLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.nextMonthLabel
...
nextMultiYearLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.nextMultiYearLabel
...
nextPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.nextPageLabel
...
nextYearLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.nextYearLabel
...
noAnimate =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.noAnimate
...
noDataLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.noDataLabel
...
noFocusTrap =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.noFocusTrap


{-| Whether the item is expanded. (default: `false`) -}
open : Bool -> M3e.Cem.Attr.Attr { c | open : M3e.Value.Supported } msg
open =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.open
...
overshootLimit =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.overshootLimit
...
pageIndex =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.pageIndex
...
pageSizes =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.pageSizes
...
panelClass =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.panelClass
...
position v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.position (M3e.Value.toString v_)
...
positionX v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.positionX (M3e.Value.toString v_)
...
positionY v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.positionY (M3e.Value.toString v_)
...
previousMonthLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.previousMonthLabel
...
previousMultiYearLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.previousMultiYearLabel
...
previousPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.previousPageLabel
...
rangeEnd =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.rangeEnd
...
rangeStart =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.rangeStart


{-| The relationship between the `target` of the link button and the document. (default: `""`) -}
rel : String -> M3e.Cem.Attr.Attr { c | rel : M3e.Value.Supported } msg
rel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.rel
...
removable =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.removable
...
removeLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.removeLabel


{-| Whether the element is required. (default: `false`) -}
required : Bool -> M3e.Cem.Attr.Attr { c | required : M3e.Value.Supported } msg
required =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.required
...
returnValue =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.returnValue
...
scheme v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.scheme (M3e.Value.toString v_)
...
selectedIndex =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.selectedIndex
...
shape v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.shape (M3e.Value.toString v_)
...
showDelay =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.showDelay
...
showFirstLastButtons =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.showFirstLastButtons
...
size v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.size (M3e.Value.toString v_)


{-| Whether the start drawer is open. (default: `false`) -}
start : Bool -> M3e.Cem.Attr.Attr { c | start : M3e.Value.Supported } msg
start =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.start
...
startAt =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.startAt
...
startDivider =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.startDivider
...
startMode v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.startMode (M3e.Value.toString v_)
...
startView v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.startView (M3e.Value.toString v_)
...
state v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.state (M3e.Value.toString v_)
...
step =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.step
...
stretch =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.stretch
...
strongFocus =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.strongFocus
...
threshold =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.threshold


{-| Today's date. (default: `new Date()`) -}
today : String -> M3e.Cem.Attr.Attr { c | today : M3e.Value.Supported } msg
today =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.today
...
toggle =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.toggle
...
type_ v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.type_ (M3e.Value.toString v_)
...
unbounded =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.unbounded
...
variant v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.variant (M3e.Value.toString v_)


{-| Whether the element is oriented vertically. (default: `false`) -}
vertical : Bool -> M3e.Cem.Attr.Attr { c | vertical : M3e.Value.Supported } msg
vertical =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.vertical
...
weight =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.weight
...
width v_ =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.width (M3e.Value.toString v_)


{-| Whether items wrap to a new line. (default: `false`) -}
wrap : Bool -> M3e.Cem.Attr.Attr { c | wrap : M3e.Value.Supported } msg
wrap =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.wrap
...
wrapDetents =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.wrapDetents
...
onChange =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onChange
...
onOpening =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onOpening
...
onOpened =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onOpened
...
onClosing =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onClosing
...
onClosed =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onClosed
...
onClick =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onClick
...
onBeforeinput =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onBeforeinput
...
onInput =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onInput
...
onBeforetoggle =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onBeforetoggle
...
onToggle =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onToggle
...
onValueChange =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onValueChange
...
onQuery =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onQuery
...
onClear =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onClear
...
onPage =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onPage
...
onCancel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onCancel
...
onRemove =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onRemove
...
onInvalid =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onInvalid
...
onActiveChange =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onActiveChange
...
onHighlight =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Vocab.onHighlight