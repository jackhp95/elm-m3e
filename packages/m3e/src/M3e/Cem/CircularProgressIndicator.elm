module M3e.Cem.CircularProgressIndicator exposing (circularProgressIndicator, indeterminate, max, value, variant)
...
indeterminate =
    M3e.Cem.Attr.attribute M3e.Cem.Html.CircularProgressIndicator.indeterminate


{-| The maximum progress value. (default: `100`) -}
max : Float -> M3e.Cem.Attr.Attr { c | max : M3e.Value.Supported } msg
max =
    M3e.Cem.Attr.attribute M3e.Cem.Html.CircularProgressIndicator.max
...
value =
    M3e.Cem.Attr.attribute M3e.Cem.Html.CircularProgressIndicator.value
