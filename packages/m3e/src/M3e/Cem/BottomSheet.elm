...
detent =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.BottomSheet.detent
...
handle =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.BottomSheet.handle
...
handleLabel =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.BottomSheet.handleLabel
...
hideable =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.BottomSheet.hideable
...
overshootLimit =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.BottomSheet.overshootLimit
