module M3e.Cem.SuggestionChip exposing (disabled, disabledInteractive, download, href, name, onClick, rel, suggestionChip, target, type_, value, variant)
...
suggestionChip attributes children =
    M3e.Cem.Html.SuggestionChip.suggestionChip
