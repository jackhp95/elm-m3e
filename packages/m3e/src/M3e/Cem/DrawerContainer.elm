module M3e.Cem.DrawerContainer exposing (drawerContainer, end, endDivider, endMode, onChange, start, startDivider, startMode)
...
drawerContainer attributes children =
    M3e.Cem.Html.DrawerContainer.drawerContainer
