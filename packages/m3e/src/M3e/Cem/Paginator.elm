...
disabled =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.disabled
...
firstPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.firstPageLabel
...
hidePageSize =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.hidePageSize
...
itemsPerPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.itemsPerPageLabel
...
lastPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.lastPageLabel
...
length =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.length
...
nextPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.nextPageLabel
...
pageIndex =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.pageIndex
...
pageSizes =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.pageSizes
...
previousPageLabel =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.previousPageLabel
...
showFirstLastButtons =
    M3e.Cem.Attr.attribute M3e.Cem.Html.Paginator.showFirstLastButtons
