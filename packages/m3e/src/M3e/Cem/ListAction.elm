...
listAction attributes children =
    M3e.Cem.Html.ListAction.listAction
...
disabled =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.ListAction.disabled
...
download =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.ListAction.download


{-| The URL to which the link button points. (default: `""`) -}
href : String -> M3e.Cem.Attr.Attr { c | href : M3e.Value.Supported } msg
href =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.ListAction.href


{-| The relationship between the `target` of the link button and the document. (default: `""`) -}
rel : String -> M3e.Cem.Attr.Attr { c | rel : M3e.Value.Supported } msg
rel =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.ListAction.rel


{-| The target of the link button. (default: `""`) -}
target : String -> M3e.Cem.Attr.Attr { c | target : M3e.Value.Supported } msg
target =
    M3e.Cem.Attr.Internal.attribute M3e.Cem.Html.ListAction.target
