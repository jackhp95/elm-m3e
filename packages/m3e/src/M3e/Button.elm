module M3e.Button exposing (button, child, children, icon, selectedIcon, selectedSlot, trailingIcon)

{-| 
@docs button, child, icon, selectedSlot, selectedIcon, trailingIcon, children
-}
