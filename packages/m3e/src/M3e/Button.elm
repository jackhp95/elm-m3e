module M3e.Button exposing (button, child, children, disabled, disabledInteractive, download, href, icon, name, onBeforeinput, onChange, onClick, onInput, rel, selected, selectedIcon, selectedSlot, shape, size, target, toggle, trailingIcon, type_, value, variant)

{-| 
@docs button, disabled, disabledInteractive, download, href, name, rel, selected, shape, size, target, toggle, type_, value, variant, onBeforeinput, onInput, onChange, onClick, child, icon, selectedSlot, selectedIcon, trailingIcon, children
-}
