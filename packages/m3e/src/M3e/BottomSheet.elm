...
[ M3e.Button.view [] [ M3e.BottomSheetTrigger.view [ M3e.BottomSheetTrigger.for "bottomSheet" ] [ Kit.text "Open bottom sheet" ] ]
    , M3e.BottomSheet.view [] [ M3e.ActionList.view [] [ M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Add to a note" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Keep" ] ], M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Embed in a document" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Docs" ] ] ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.BottomSheetTrigger.view [ M3e.BottomSheetTrigger.for "bottomSheet2" ] [ Kit.text "Open modal bottom sheet" ] ]
    , M3e.BottomSheet.view [ M3e.BottomSheet.modal True ] [ M3e.ActionList.view [] [ M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Add to a note" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Keep" ] ], M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Embed in a document" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Docs" ] ] ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.BottomSheetTrigger.view [ M3e.BottomSheetTrigger.for "bottomSheet3" ] [ Kit.text "Open draggable modal bottom sheet" ] ]
    , M3e.BottomSheet.view [ M3e.BottomSheet.modal True, M3e.BottomSheet.handle True ] [ M3e.ActionList.view [] [ M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Add to a note" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Keep" ] ], M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Embed in a document" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Docs" ] ] ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.BottomSheetTrigger.view [ M3e.BottomSheetTrigger.for "bottomSheet7" ] [ Kit.text "Open draggable modal bottom sheet with detents at half" ] ]
    , M3e.BottomSheet.view [ M3e.BottomSheet.modal True, M3e.BottomSheet.handle True, M3e.BottomSheet.detent 1 ] [ M3e.ActionList.view [] [ M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Add to a note" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Keep" ] ], M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Embed in a document" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Docs" ] ] ] ]
    ]
```
...
[ M3e.Button.view [] [ M3e.BottomSheetTrigger.view [ M3e.BottomSheetTrigger.for "bottomSheet5" ] [ Kit.text "Open hideable modal bottom sheet" ] ]
    , M3e.BottomSheet.view [ M3e.BottomSheet.modal True, M3e.BottomSheet.handle True, M3e.BottomSheet.hideable True ] [ M3e.ActionList.view [] [ M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Add to a note" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Keep" ] ], M3e.ListAction.view [] [ M3e.ListAction.supportingText (Native.span [] [ Kit.text "Embed in a document" ]), M3e.BottomSheetAction.view [] [ Kit.text "Google Docs" ] ] ] ]
    ]
```
