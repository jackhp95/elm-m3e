...
```elm
M3e.OptionPanel.view [ M3e.OptionPanel.fitAnchorWidth True ] (M3e.OptionPanel.children [ M3e.Option.view [ M3e.Option.value "apple" ] [ M3e.Option.child (Kit.text "Apple") ], M3e.Option.view [ M3e.Option.value "banana" ] [ M3e.Option.child (Kit.text "Banana") ], M3e.Optgroup.view [] ([ M3e.Optgroup.label (Kit.text "Citrus") ] ++ M3e.Optgroup.children [ M3e.Option.view [ M3e.Option.value "lemon" ] [ M3e.Option.child (Kit.text "Lemon") ], M3e.Option.view [ M3e.Option.value "orange", M3e.Option.selected True ] [ M3e.Option.child (Kit.text "Orange") ], M3e.Option.view [ M3e.Option.value "grapefruit", M3e.Option.disabled True ] [ M3e.Option.child (Kit.text "Grapefruit") ] ]) ])
```
