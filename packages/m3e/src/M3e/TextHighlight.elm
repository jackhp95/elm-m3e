module M3e.TextHighlight exposing (caseSensitive, child, children, disabled, mode, onHighlight, term, textHighlight)

{-| 
@docs textHighlight, caseSensitive, disabled, mode, term, onHighlight, child, children
-}
