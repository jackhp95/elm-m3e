module M3e.Cem.Button exposing (component, disabled, disabledInteractive, download, href, iconSlot, name, onBeforeinput, onChange, onClick, onInput, rel, selected, selectedIconSlot, selectedSlot, shape, size, target, toggle, trailingIconSlot, type_, value, variant)
...
@docs disabled, disabledInteractive, download, href, name, rel, selected, shape, size, target, toggle, type_, value, variant
