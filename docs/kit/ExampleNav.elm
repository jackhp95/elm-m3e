...
footer :
    ...
    -> Element { s | html : Supported, link : Supported } msg
...
builtFromRow : List ( String, String ) -> Element { s | html : Supported, link : Supported } msg
builtFromRow builtFrom =
...
componentLink : ( String, String ) -> Element { s | html : Supported, link : Supported } msg
...
-}
pagerSlot : String -> Maybe ( String, String ) -> Element { s | html : Supported, link : Supported } msg
