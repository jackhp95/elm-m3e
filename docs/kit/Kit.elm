...
-}
textLink : String -> List TextColor -> List (Element s msg) -> Element { k | link : Supported } msg
...
-}
display : Size -> List TextColor -> List (Element s msg) -> Element { k | html : Supported } msg
display =
...
-}
headline : Size -> List TextColor -> List (Element s msg) -> Element { k | html : Supported } msg
headline =
...
-}
title : Size -> List TextColor -> List (Element s msg) -> Element { k | html : Supported } msg
title =
...
-}
body : Size -> List TextColor -> List (Element s msg) -> Element { k | html : Supported } msg
body =
...
-}
code : Size -> List TextColor -> List (Element s msg) -> Element { k | html : Supported } msg
code =
