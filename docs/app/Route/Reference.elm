...
-}
twoForms : Element { s | html : Supported } msg
twoForms =
...
-}
barrelBlock : Component -> Element { s | html : Supported } msg
barrelBlock c =
    Native.section
...
-}
barrelGroup : String -> (Member -> Bool) -> List Member -> Element { s | html : Supported } msg
