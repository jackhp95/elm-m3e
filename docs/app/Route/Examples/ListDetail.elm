...
-}
screen : Model -> Element { s | html : Supported, link : Supported } Msg
screen model =
...
-}
listPane : Int -> Element { s | html : Supported, list : Supported } Msg
listPane selected =
...
-}
contactRow : Int -> Int -> Contact -> Element { s | listItem : Supported } Msg
...
-}
detailPane : Contact -> Element { s | html : Supported } msg
detailPane contact =
...
header : Contact -> Element { s | html : Supported } msg
header contact =
...
-}
detailCard : Contact -> Element { s | html : Supported } msg
detailCard contact =
...
fieldRow : String -> String -> String -> Element { s | listItem : Supported } msg
