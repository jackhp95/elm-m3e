...
saveButton : Element { s | button : Supported } msg
saveButton =
...
-}
twoColumn : Element { s | html : Supported } msg
twoColumn =
...
-}
linkNav : Element { s | navMenu : Supported } msg
linkNav =
    M3e.navMenu []
...
text : String -> Element { s | text : Supported } msg
text raw =
...
linkNavCode : String
linkNavCode =
    """-- the label slot admits { text : Supported, link : Supported }, so the
