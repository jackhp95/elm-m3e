...
head _ =
    Seo.summary
        ...
        , description = "The Guide glossary: the twelve kept terms — layer, form, barrel, component module, generic/component setters, kind, slot, token, seam, component facts, manifest — each defined in plain words."
        , locale = Nothing
