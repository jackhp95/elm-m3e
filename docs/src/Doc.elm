...
-}
pageHeading : String -> Element { s | heading : Supported } msg
pageHeading s =
    M3e.heading [ M3e.variantDisplay, M3e.sizeSmall, M3e.attrLevel 1 ] [ Kit.text s ]
...
sectionHeading s =
    M3e.heading [ M3e.variantHeadline, M3e.sizeSmall, M3e.attrLevel 2 ] [ Kit.text s ]


{-| The chapter recap box: an "Recap" overline over rendered markdown, in a
tinted container.
-}
recapBox : String -> Element { s | html : Supported } msg
recapBox md =
...
-}
callout : String -> String -> Element { s | html : Supported } msg
callout label body =
    Seam.fromHtml
        (div
...
-}
userlandNote : Element { s | html : Supported } msg
userlandNote =
