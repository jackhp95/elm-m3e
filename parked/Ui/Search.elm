...
# Spec deviations
  ...
  - **Leading/trailing slot overrides aren't exposed.** The SearchBar
    auto-injects a FontAwesome magnifying-glass into the leading slot
    (matching the legacy default — `M3e.SearchBar` itself doesn't render
    one). The SearchView auto-renders its own search icon unless
...
defaultLeading =
    span [ M3e.SearchBar.leadingSlot ]
        [ Ui.Icon.view (Ui.Icon.fontAwesome FA.magnifyingGlass) ]
