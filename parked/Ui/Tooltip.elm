        ...
        PlainKind label ->
            M3e.Tooltip.component
                (List.filterMap identity
                    ...
                    , Maybe.map (M3e.Tooltip.hideDelay << String.fromInt) cfg.hideDelay
                    ]
                )
                [ Html.text label ]
        ...
        RichKind content ->
            M3e.RichTooltip.component
                (List.filterMap identity
                    ...
                    , Maybe.map (M3e.RichTooltip.hideDelay << String.fromInt) cfg.hideDelay
                    ]
                )
...
plainPositionAttr p =
    case p of
        Above ->
            M3e.Tooltip.positionAbove

        Below ->
            M3e.Tooltip.positionBelow

        Before ->
            M3e.Tooltip.positionBefore
...
richPositionAttr p =
    case p of
        Above ->
            M3e.RichTooltip.positionAboveAfter

        Below ->
            M3e.RichTooltip.positionBelowBefore
