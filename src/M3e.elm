...
{-| See `M3e.DateInput.view`.
-}
dateInput :
    List (Attr M3e.DateInput.Attrs msg)
    -> List (Element childAccepts (M3e.DateInput.ChildAdmittedBy childAdm) msg)
    -> Element (M3e.DateInput.Is s) admittedBy msg
dateInput =
    M3e.DateInput.view
...
{-| See `M3e.SelectionIndicator.view`.
-}
selectionIndicator :
    List (Attr M3e.SelectionIndicator.Attrs msg)
    -> List (Element childAccepts (M3e.SelectionIndicator.ChildAdmittedBy childAdm) msg)
    -> Element (M3e.SelectionIndicator.Is s) admittedBy msg
selectionIndicator =
    M3e.SelectionIndicator.view
