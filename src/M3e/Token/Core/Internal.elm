module M3e.Token.Core.Internal exposing
    ( Value(..), Supported
    , toString, token
    )

{-| The **unfenced** interior of [`M3e.Token.Core`](M3e-Value-Core): the opaque
...
generated `M3e.*` code (the generated `M3e.Token` token declarations call it at a
...
free assertion — so this lives out of `M3e.Token.Core`'s public surface.
-}
