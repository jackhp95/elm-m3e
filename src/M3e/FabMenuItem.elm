module M3e.FabMenuItem exposing
    ...
    , icon
    , withAriaLabel, withChild, withClass, withDisabled, withDownload, withHref, withIcon, withId, withOnClick, withRel, withSlot, withStyle, withTarget
    )
...
@docs icon
@docs withAriaLabel, withChild, withClass, withDisabled, withDownload, withHref, withIcon, withId, withOnClick, withRel, withSlot, withStyle, withTarget
