...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.TreeItem.disabled
...
indeterminate =
    M3e.Html.Attr.Internal.attribute M3e.Raw.TreeItem.indeterminate
...
open =
    M3e.Html.Attr.Internal.attribute M3e.Raw.TreeItem.open
...
selected =
    M3e.Html.Attr.Internal.attribute M3e.Raw.TreeItem.selected
