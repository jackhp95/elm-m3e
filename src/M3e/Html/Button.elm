...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.disabled
...
disabledInteractive :
    ...
    ->
        Markup.Html.Attr.Attr
            ...
            msg
disabledInteractive =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.disabledInteractive
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.download
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.href
...
name =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.name
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.rel
...
selected =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.selected
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.target
...
toggle =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.toggle
...
value =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Button.value
