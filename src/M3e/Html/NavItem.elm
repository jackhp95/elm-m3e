module M3e.Html.NavItem exposing
...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.disabled
...
disabledInteractive :
    ...
    ->
        Markup.Html.Attr.Attr
            ...
            msg
disabledInteractive =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.disabledInteractive
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.download
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.href
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.rel
...
selected =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.selected
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.NavItem.target
