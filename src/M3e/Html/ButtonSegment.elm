...
checked =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ButtonSegment.checked
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ButtonSegment.disabled
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ButtonSegment.value
