...
badge attributes children =
    M3e.Raw.Badge.badge (List.map M3e.Html.Attr.toAttribute attributes) children
...
size v_ =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Badge.size (M3e.Token.toString v_)
...
for =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Badge.for
