...
contained =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SearchView.contained
...
open =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SearchView.open
...
clearLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SearchView.clearLabel
...
closeLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SearchView.closeLabel
...
hideSearchIcon =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SearchView.hideSearchIcon
