...
action =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Snackbar.action
...
closeLabel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Snackbar.closeLabel
...
dismissible =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Snackbar.dismissible
...
duration =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Snackbar.duration
