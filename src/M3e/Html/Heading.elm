...
emphasized =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Heading.emphasized
...
level =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Heading.level
...
tocIgnore =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Heading.tocIgnore
