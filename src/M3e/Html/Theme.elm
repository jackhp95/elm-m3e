...
theme attributes children =
    M3e.Raw.Theme.theme (List.map M3e.Html.Attr.toAttribute attributes) children
...
color =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Theme.color
...
density =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Theme.density
...
strongFocus =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Theme.strongFocus
