...
itemLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.itemLabel
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.disabled
...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.href
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.target
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.download
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.BreadcrumbItem.rel
