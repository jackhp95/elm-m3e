...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ExpansionPanel.disabled
...
hideToggle =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ExpansionPanel.hideToggle
...
open =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ExpansionPanel.open
