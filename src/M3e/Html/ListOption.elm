...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListOption.disabled
...
selected =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListOption.selected
...
value =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListOption.value
