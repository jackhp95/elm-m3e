...
actionable =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.actionable
...
inline =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.inline
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.href
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.target
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.rel
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.download
...
name =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.name
...
value =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.value
...
disabledInteractive :
    ...
    ->
        Markup.Html.Attr.Attr
            ...
            msg
disabledInteractive =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.disabledInteractive
...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Card.disabled
