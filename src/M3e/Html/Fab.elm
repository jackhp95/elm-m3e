...
fab attributes children =
    M3e.Raw.Fab.fab (List.map M3e.Html.Attr.toAttribute attributes) children
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.disabled
...
disabledInteractive =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.disabledInteractive
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.download
...
extended =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.extended
...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.href
...
lowered =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.lowered
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.name
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.rel
...
size v_ =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.size (M3e.Token.toString v_)
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.target
...
type_ v_ =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.type_ (M3e.Token.toString v_)
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.value
...
variant v_ =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Fab.variant (M3e.Token.toString v_)
