...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.disabled
...
disabledInteractive =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.disabledInteractive
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.download
...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.href
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.name
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.rel
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.target
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.AssistChip.value
