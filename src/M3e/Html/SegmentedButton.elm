...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SegmentedButton.disabled
...
multi =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SegmentedButton.multi
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SegmentedButton.name
