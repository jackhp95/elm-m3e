...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.disabled
...
disabledInteractive =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.disabledInteractive
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.download
...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.href
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.name
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.rel
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.target
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SuggestionChip.value
