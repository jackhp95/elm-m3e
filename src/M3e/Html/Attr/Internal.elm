module M3e.Html.Attr.Internal exposing
    ( Attr(..)
    , attribute, toAttribute, forget, slot
    )

{-| The **unfenced** interior of [`M3e.Html.Attr`](M3e-Cem-Attr): the opaque
...
the generated typed setters, which carry a concrete capability.
...
free assertion — so this lives out of `M3e.Html.Attr`'s public surface.
-}
