...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuItem.disabled
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuItem.download
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuItem.href
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuItem.rel
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuItem.target
