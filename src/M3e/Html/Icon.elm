...
icon attributes children =
    M3e.Raw.Icon.icon (List.map M3e.Html.Attr.toAttribute attributes) children
...
filled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Icon.filled
...
grade v_ =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Icon.grade (M3e.Token.toString v_)
...
opticalSize =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Icon.opticalSize
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Icon.name
...
weight =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Icon.weight
