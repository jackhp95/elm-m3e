...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.RichTooltip.disabled
...
for =
    M3e.Html.Attr.Internal.attribute M3e.Raw.RichTooltip.for
...
hideDelay =
    M3e.Html.Attr.Internal.attribute M3e.Raw.RichTooltip.hideDelay
...
showDelay =
    M3e.Html.Attr.Internal.attribute M3e.Raw.RichTooltip.showDelay
