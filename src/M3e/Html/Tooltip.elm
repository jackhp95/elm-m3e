...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tooltip.disabled
...
for =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tooltip.for
...
hideDelay =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tooltip.hideDelay
...
showDelay =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tooltip.showDelay
