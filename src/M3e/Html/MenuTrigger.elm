module M3e.Html.MenuTrigger exposing (menuTrigger, for)
...
menuTrigger attributes children =
    M3e.Raw.MenuTrigger.menuTrigger
...
for =
    Markup.Html.Attr.Internal.attribute M3e.Raw.MenuTrigger.for
