...
detents =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.detents
...
label =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.label
...
max =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.max
...
min =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.min
...
overshootLimit =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.overshootLimit
...
step =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.step
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.value
...
wrapDetents =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.wrapDetents
...
name =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.name
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.SplitPane.disabled
