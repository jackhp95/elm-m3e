...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.disabled
...
disabledInteractive :
    ...
    ->
        Markup.Html.Attr.Attr
            ...
            msg
disabledInteractive =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.disabledInteractive
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.download
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.href
...
name =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.name
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.rel
...
selected =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.selected
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.target
...
toggle =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.toggle
...
value =
    Markup.Html.Attr.Internal.attribute M3e.Raw.IconButton.value
