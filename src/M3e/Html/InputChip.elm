...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.InputChip.disabled
...
disabledInteractive =
    M3e.Html.Attr.Internal.attribute M3e.Raw.InputChip.disabledInteractive
...
removable =
    M3e.Html.Attr.Internal.attribute M3e.Raw.InputChip.removable
...
removeLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.InputChip.removeLabel
...
value =
    M3e.Html.Attr.Internal.attribute M3e.Raw.InputChip.value
