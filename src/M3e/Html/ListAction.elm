...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListAction.disabled
...
download =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListAction.download
...
href =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListAction.href
...
rel =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListAction.rel
...
target =
    Markup.Html.Attr.Internal.attribute M3e.Raw.ListAction.target
