...
checked =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.checked
...
disabled =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.disabled
...
indeterminate =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.indeterminate
...
name =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.name
...
required =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.required
...
value =
    Markup.Html.Attr.Internal.attribute M3e.Raw.Checkbox.value
