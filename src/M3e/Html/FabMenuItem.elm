module M3e.Html.FabMenuItem exposing
...
fabMenuItem attributes children =
    M3e.Raw.FabMenuItem.fabMenuItem
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.FabMenuItem.disabled
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.FabMenuItem.download
...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.FabMenuItem.href
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.FabMenuItem.rel
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.FabMenuItem.target
