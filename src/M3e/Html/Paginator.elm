...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.disabled
...
firstPageLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.firstPageLabel
...
hidePageSize =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.hidePageSize
...
itemsPerPageLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.itemsPerPageLabel
...
lastPageLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.lastPageLabel
...
length =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.length
...
nextPageLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.nextPageLabel
...
pageIndex =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.pageIndex
...
pageSizes =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.pageSizes
...
previousPageLabel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.previousPageLabel
...
showFirstLastButtons =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Paginator.showFirstLastButtons
