...
tab attributes children =
    M3e.Raw.Tab.tab (List.map M3e.Html.Attr.toAttribute attributes) children
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tab.disabled
...
for =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tab.for
...
selected =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tab.selected
