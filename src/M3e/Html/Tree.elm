...
tree attributes children =
    M3e.Raw.Tree.tree (List.map M3e.Html.Attr.toAttribute attributes) children
...
multi =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tree.multi
...
cascade =
    M3e.Html.Attr.Internal.attribute M3e.Raw.Tree.cascade
