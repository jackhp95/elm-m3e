...
href =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ListItemButton.href
...
target =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ListItemButton.target
...
rel =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ListItemButton.rel
...
download =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ListItemButton.download
...
disabled =
    M3e.Html.Attr.Internal.attribute M3e.Raw.ListItemButton.disabled
