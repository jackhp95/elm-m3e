...
-}
withDialLabel : String -> Builder { a | dialLabel : Available } slotCaps msg -> Builder { a | dialLabel : Used } slotCaps msg
...
-}
withHideModeToggle : Bool -> Builder { a | hideModeToggle : Available } slotCaps msg -> Builder { a | hideModeToggle : Used } slotCaps msg
...
-}
withInputLabel : String -> Builder { a | inputLabel : Available } slotCaps msg -> Builder { a | inputLabel : Used } slotCaps msg
...
-}
withModeToggleLabel : String -> Builder { a | modeToggleLabel : Available } slotCaps msg -> Builder { a | modeToggleLabel : Used } slotCaps msg
