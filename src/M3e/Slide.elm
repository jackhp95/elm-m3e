...
{-| Pipe form of `selectedIndex` — consumes its capability (write-once).
-}
withSelectedIndex : Float -> Builder { a | selectedIndex : Available } slotCaps msg -> Builder { a | selectedIndex : Used } slotCaps msg
withSelectedIndex value_ (Builder b) =
    Builder { b | attrs = M3e.Attributes.selectedIndex value_ :: b.attrs }
