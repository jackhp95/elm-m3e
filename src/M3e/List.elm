...
```elm
M3e.List.view [] [ M3e.ListItem.view [] [ Kit.text "Item 1" ], M3e.ListItem.view [] [ Kit.text "Item 2" ], M3e.ListItem.view [] [ Kit.text "Item 3" ] ]
```
...
```elm
M3e.ActionList.view [ M3e.ActionList.variant M3e.Value.segmented ] [ M3e.ExpandableListItem.view [] [ M3e.ExpandableListItem.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item", M3e.ExpandableListItem.items (Native.div [] [ M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ] ]) ], M3e.ExpandableListItem.view [] [ M3e.ExpandableListItem.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item", M3e.ExpandableListItem.items (Native.div [] [ M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ] ]) ], M3e.ExpandableListItem.view [] [ M3e.ExpandableListItem.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item", M3e.ExpandableListItem.items (Native.div [] [ M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ], M3e.ListAction.view [] [ M3e.ListAction.leading (M3e.Icon.view [ M3e.Icon.name "stars" ] []), Kit.text "List item" ] ]) ] ]
```
