module M3e.Raw.PseudoCheckbox exposing (pseudoCheckbox, checked, disabled, indeterminate)

{-| Bottom layer for `<m3e-pseudo-checkbox>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
...
-}
pseudoCheckbox : List (Html.Attribute msg) -> List (Html.Html msg) -> Html.Html msg
pseudoCheckbox =
