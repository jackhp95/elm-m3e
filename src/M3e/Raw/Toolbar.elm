module M3e.Raw.Toolbar exposing (toolbar, elevated, shape, variant, vertical)

{-| Bottom layer for `<m3e-toolbar>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
