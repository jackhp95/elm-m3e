module M3e.Raw.SplitPane exposing
...
{-| Bottom layer for `<m3e-split-pane>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
