module M3e.Raw.ThemeIcon exposing (themeIcon, color, scheme, variant)

{-| Bottom layer for `<m3e-theme-icon>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
