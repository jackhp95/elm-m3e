module M3e.Raw.PseudoRadio exposing (pseudoRadio, checked, disabled)

{-| Bottom layer for `<m3e-pseudo-radio>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
