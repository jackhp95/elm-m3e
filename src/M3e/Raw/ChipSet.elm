module M3e.Raw.ChipSet exposing (chipSet, vertical)

{-| Bottom layer for `<m3e-chip-set>`: the plain `elm/html` API — one element constructor plus raw attribute and event setters, faithful DOM emission, no phantom typing. The rawest escape in the gradient.
