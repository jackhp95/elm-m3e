...
[`M3e.Value.Core.Internal`](M3e-Value-Core-Internal), reachable only by generated
`M3e.*` code and a team's `Seam` module (ADR 0014 §2). The extraction
...
import M3e.Value.Core.Internal as I


{-| A phantom-tagged string token, opaque and re-exported from
[`M3e.Value.Core.Internal`](M3e-Value-Core-Internal).
-}
