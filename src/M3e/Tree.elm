...
```elm
M3e.Tree.view [] [ M3e.TreeItem.view [ M3e.TreeItem.open True ] [ M3e.TreeItem.label (Kit.text "Getting Started"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Overview") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Installation") ] ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Components"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Button") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Card") ] ] ]
```

<!-- elm-cem:example title="Selection" -->
```elm
M3e.Tree.view [] [ M3e.TreeItem.view [ M3e.TreeItem.open True ] [ M3e.TreeItem.label (Kit.text "Getting Started"), M3e.TreeItem.view [ M3e.TreeItem.selected True ] [ M3e.TreeItem.label (Kit.text "Overview") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Installation") ] ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Components"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Button") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Card") ] ] ]
```

<!-- elm-cem:example title="Multiple selection" -->
```elm
M3e.Tree.view [ M3e.Tree.multi True ] [ M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Fruits"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Apples") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Oranges") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Bananas") ] ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Vegetables"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Carrots") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Broccoli") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Spinach") ] ] ]
```

<!-- elm-cem:example title="Cascade selection" -->
```elm
M3e.Tree.view [ M3e.Tree.multi True, M3e.Tree.cascade True ] [ M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Fruits"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Apples") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Oranges") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Bananas") ] ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Vegetables"), M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Carrots") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Broccoli") ], M3e.TreeItem.view [] [ M3e.TreeItem.label (Kit.text "Spinach") ] ] ]
```
