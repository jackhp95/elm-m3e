module M3e.BreadcrumbItem exposing
    ...
    , icon
    , withAriaLabel, withChild, withClass, withCurrent, withDisabled, withDownload, withHref, withIcon, withId, withItemLabel, withOnClick, withRel, withSlot, withStyle, withTarget
    )
...
@docs icon
@docs withAriaLabel, withChild, withClass, withCurrent, withDisabled, withDownload, withHref, withIcon, withId, withItemLabel, withOnClick, withRel, withSlot, withStyle, withTarget
...
{-| Narrowed value setter for `current`. Tokens come from `M3e.Values`.
-}
...
toElement (Builder b) =
    Ir.fromNode (Ir.node "m3e-breadcrumb-item" (List.reverse b.attrs) (List.reverse b.children))
...
withCurrent value_ (Builder b) =
    Builder { b | attrs = current value_ :: b.attrs }
...
withItemLabel value_ (Builder b) =
    Builder { b | attrs = M3e.Attributes.itemLabel value_ :: b.attrs }
