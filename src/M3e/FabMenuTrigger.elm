module M3e.FabMenuTrigger exposing
    ( view, build, toElement
    , Is, Attrs, ChildAdmittedBy, Builder, AttrCaps, SlotCaps
    , for
    , withAriaLabel, withClass, withFor, withId, withSlot, withStyle
    )
...
@docs for
@docs withAriaLabel, withClass, withFor, withId, withSlot, withStyle
...
toElement (Builder b) =
    Ir.fromNode (Ir.node "m3e-fab-menu-trigger" (List.reverse b.attrs) (List.reverse b.children))
