...
badge element =
    Ir.fromNode (Ir.addAttribute (Ir.attribute "slot" "badge") (HtmlIr.Element.toNode element))
...
{-| Pipe form of the `badge` slot — consumes its capability (write-once).
-}
withBadge : Element BadgeSlot admittedBy msg -> Builder attrCaps { s | badge : Available } msg -> Builder attrCaps { s | badge : Used } msg
withBadge element (Builder b) =
    Builder { b | children = HtmlIr.Element.toNode (badge element) :: b.children }
