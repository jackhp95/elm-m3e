module M3e.DialogAction exposing
    ...
    , returnValue
    , withAriaLabel, withChild, withClass, withId, withReturnValue, withSlot, withStyle
    )
...
@docs returnValue
@docs withAriaLabel, withChild, withClass, withId, withReturnValue, withSlot, withStyle
