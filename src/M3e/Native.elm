...
-}
input : List (Attr { checked : Supported, disabled : Supported, max : Supported, min : Supported, multiple : Supported, name : Supported, placeholder : Supported, readonly : Supported, required : Supported, slot : Supported, step : Supported, type_ : Supported, value : Supported } msg) -> Element { k | html : M3e.Kind.Brand } msg
input attrs =
    Element.fromNode
        (Node.fromComponent
...
-}
textarea : List (Attr { cols : Supported, disabled : Supported, name : Supported, placeholder : Supported, readonly : Supported, required : Supported, rows : Supported, slot : Supported, value : Supported } msg) -> List (Element s msg) -> Element { k | html : M3e.Kind.Brand } msg
...
-}
select : List (Attr { disabled : Supported, multiple : Supported, name : Supported, required : Supported, slot : Supported } msg) -> List (Element s msg) -> Element { k | html : M3e.Kind.Brand } msg
...
-}
button : List (Attr { disabled : Supported, name : Supported, slot : Supported, type_ : Supported, value : Supported } msg) -> List (Element s msg) -> Element { k | html : M3e.Kind.Brand } msg
...
-}
img : List (Attr { alt : Supported, height : Supported, slot : Supported, src : Supported, width : Supported } msg) -> Element { k | html : M3e.Kind.Brand } msg
img attrs =
    Element.fromNode
        (Node.fromComponent
