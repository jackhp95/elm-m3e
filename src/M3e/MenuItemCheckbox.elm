module M3e.MenuItemCheckbox exposing (view, disabled, checked, onClick, icon, trailingIcon)
...
disabled =
    M3e.Html.MenuItemCheckbox.disabled
...
checked =
    M3e.Html.MenuItemCheckbox.checked
...
onClick =
    M3e.Html.MenuItemCheckbox.onClick
