...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | richTooltip : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.for v_))
            (M3e.Build.Internal.node_ b_)
        )
...
hideDelay v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.hideDelay v_))
            (M3e.Build.Internal.node_ b_)
        )
...
position v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.position v_))
            (M3e.Build.Internal.node_ b_)
        )
...
showDelay v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.showDelay v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onToggle v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RichTooltip.onToggle v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { richTooltip : M3e.Token.Supported } msg
build b_ =
