    ...
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MultiYearView.active v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
today v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MultiYearView.today v_))
            (M3e.Build.Internal.node_ b_)
        )
...
date v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MultiYearView.date v_))
            (M3e.Build.Internal.node_ b_)
        )
...
minDate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MultiYearView.minDate v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
maxDate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MultiYearView.maxDate v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MultiYearView.onChange v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { multiYearView : M3e.Kind.Brand } msg
build b_ =
