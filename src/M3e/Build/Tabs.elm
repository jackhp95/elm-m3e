    ...
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Tabs.disablePagination v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
headerPosition v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.headerPosition v_))
            (M3e.Build.Internal.node_ b_)
        )
...
nextPageLabel v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.nextPageLabel v_))
            (M3e.Build.Internal.node_ b_)
        )
...
previousPageLabel v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Tabs.previousPageLabel v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
stretch v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.stretch v_))
            (M3e.Build.Internal.node_ b_)
        )
...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.onChange v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onBeforeinput v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.onBeforeinput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Tabs.onInput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
-}
build : Builder a s msg kind -> Markup.Element.Element { tabs : M3e.Kind.Brand } msg
build b_ =
