...
{-| The Build form for `<m3e-menu-item-checkbox>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.MenuItemCheckbox as MenuItemCheckbox`.
...
import M3e.Html.MenuItemCheckbox
import M3e.Node
import M3e.Token
...
menuItemCheckbox =
    M3e.Build.Internal.wrap_
        (M3e.Node.fromComponent
            (\erased_ ch_ ->
                M3e.Html.MenuItemCheckbox.menuItemCheckbox
    ...
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.MenuItemCheckbox.disabled v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
checked v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.MenuItemCheckbox.checked v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.MenuItemCheckbox.onClick v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { menuItemCheckbox : M3e.Token.Supported } msg
build b_ =
