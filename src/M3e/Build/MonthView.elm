    ...
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MonthView.rangeStart v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
rangeEnd v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.rangeEnd v_))
            (M3e.Build.Internal.node_ b_)
        )
...
active v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.active v_))
            (M3e.Build.Internal.node_ b_)
        )
...
today v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.today v_))
            (M3e.Build.Internal.node_ b_)
        )
...
date v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.date v_))
            (M3e.Build.Internal.node_ b_)
        )
...
activeDate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.MonthView.activeDate v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
minDate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.minDate v_))
            (M3e.Build.Internal.node_ b_)
        )
...
maxDate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.maxDate v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.MonthView.onChange v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { monthView : M3e.Kind.Brand } msg
build b_ =
