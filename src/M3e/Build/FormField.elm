module M3e.Build.FormField exposing
    ...
    , hideRequiredMarker, hideSubscript, variant, prefix, prefixText, suffix
    , suffixText, hint, error, build
    )

{-| The Build form for `<m3e-form-field>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.FormField as FormField`.
    ...
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.FormField.floatLabel v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
hideRequiredMarker v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.FormField.hideRequiredMarker v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
hideSubscript v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.FormField.hideSubscript v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.FormField.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
prefix el_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addChild
            (Markup.Element.toNode (Markup.Element.withSlot "prefix" el_))
            (M3e.Build.Internal.node_ b_)
        )
...
prefixText el_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addChild
            (Markup.Element.toNode (Markup.Element.withSlot "prefix-text" el_))
            (M3e.Build.Internal.node_ b_)
        )
...
suffix el_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addChild
            (Markup.Element.toNode (Markup.Element.withSlot "suffix" el_))
            (M3e.Build.Internal.node_ b_)
        )
...
suffixText el_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addChild
            (Markup.Element.toNode (Markup.Element.withSlot "suffix-text" el_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { formField : M3e.Kind.Brand } msg
build b_ =
