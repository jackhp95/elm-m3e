...
open v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Collapsible.open v_))
            (M3e.Build.Internal.node_ b_)
        )
...
noAnimate v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Collapsible.noAnimate v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onOpening v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Collapsible.onOpening v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onOpened v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Collapsible.onOpened v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onClosing v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Collapsible.onClosing v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onClosed v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.Collapsible.onClosed v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { collapsible : M3e.Kind.Brand } msg
build b_ =
