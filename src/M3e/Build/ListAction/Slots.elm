module M3e.Build.ListAction.Slots exposing
    ...
    , dialogTrigger, dialogAction, datepickerToggle, richTooltipAction, bottomSheetTrigger, bottomSheetAction, leadingIcon
    , leadingAvatar, trailingSwitch, trailingRadio, trailingIcon, trailingCheckbox, trailingAvatar
    )
...
{-| Place a `Icon` in the `trailing` slot of `ListAction`. -}
trailingIcon :
    M3e.Build.Icon.Builder ca cs msg ck
    -> M3e.Build.ListAction.Builder pa { ps
        | trailing : M3e.Build.Internal.Available
