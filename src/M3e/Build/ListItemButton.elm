...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | listItemButton : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
href v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ListItemButton.href v_))
            (M3e.Build.Internal.node_ b_)
        )
...
target v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ListItemButton.target v_))
            (M3e.Build.Internal.node_ b_)
        )
...
rel v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ListItemButton.rel v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ListItemButton.onClick v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { listItemButton : M3e.Token.Supported } msg
build b_ =
