...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
download v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.download v_))
            (M3e.Build.Internal.node_ b_)
        )
...
href v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.href v_))
            (M3e.Build.Internal.node_ b_)
        )
...
rel v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.rel v_))
            (M3e.Build.Internal.node_ b_)
        )
...
target v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.target v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenuItem.onClick v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { fabMenuItem : M3e.Token.Supported } msg
build b_ =
