...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
    ...
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.TreeItem.indeterminate v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
open v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.open v_))
            (M3e.Build.Internal.node_ b_)
        )
...
selected v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.selected v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onOpening v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.onOpening v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onOpened v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.onOpened v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClosing v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.onClosing v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClosed v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.onClosed v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TreeItem.onClick v_))
            (M3e.Build.Internal.node_ b_)
        )
...
openToggleIcon el_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addChild
            (Markup.Element.toNode
                (Markup.Element.withSlot "open-toggle-icon" el_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { treeItem : M3e.Kind.Brand } msg
build b_ =
