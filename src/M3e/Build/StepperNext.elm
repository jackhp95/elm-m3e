...
{-|
The ⑤ Build shape for `<m3e-stepper-next>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.StepperNext as StepperNext`.
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { stepperNext : M3e.Value.Supported } msg
build b_ =
