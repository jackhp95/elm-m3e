...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenu.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onBeforetoggle v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenu.onBeforetoggle v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onToggle v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FabMenu.onToggle v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { fabMenu : M3e.Token.Supported } msg
build b_ =
