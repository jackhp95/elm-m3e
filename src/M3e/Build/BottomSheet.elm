...
detent v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BottomSheet.detent v_))
            (M3e.Build.Internal.node_ b_)
        )
...
detents v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BottomSheet.detents v_))
            (M3e.Build.Internal.node_ b_)
        )
...
handle v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BottomSheet.handle v_))
            (M3e.Build.Internal.node_ b_)
        )
...
hideable v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.hideable v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
modal v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BottomSheet.modal v_))
            (M3e.Build.Internal.node_ b_)
        )
...
open v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BottomSheet.open v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onOpening v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.onOpening v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onClosing v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.onClosing v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onCancel v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.onCancel v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onOpened v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.onOpened v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onClosed v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BottomSheet.onClosed v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { bottomSheet : M3e.Kind.Brand } msg
build b_ =
