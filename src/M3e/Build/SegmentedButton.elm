...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | segmentedButton : M3e.Kind.Brand
        }
        attrCaps
        slotCaps
        msg
...
multi v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.multi v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
name v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.name v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    ...
    -> Markup.Element.Element { segmentedButton : M3e.Kind.Brand } msg
build b_ =
