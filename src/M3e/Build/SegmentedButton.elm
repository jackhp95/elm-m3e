module M3e.Build.SegmentedButton exposing
    ...
    , hideSelectionIndicator, multi, name, onChange, onBeforeinput, onInput
    , build
    )

{-| The Build form for `<m3e-segmented-button>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.SegmentedButton as SegmentedButton`.
...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | segmentedButton : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
    ...
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.disabled v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
hideSelectionIndicator v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.hideSelectionIndicator v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
multi v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.SegmentedButton.multi v_))
            (M3e.Build.Internal.node_ b_)
        )
...
name v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.SegmentedButton.name v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.onChange v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onBeforeinput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.onBeforeinput v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.SegmentedButton.onInput v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    ...
    -> M3e.Element.Element { segmentedButton : M3e.Token.Supported } msg
build b_ =
