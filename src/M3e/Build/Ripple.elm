...
centered v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Ripple.centered v_))
            (M3e.Build.Internal.node_ b_)
        )
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Ripple.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Ripple.for v_))
            (M3e.Build.Internal.node_ b_)
        )
...
radius v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Ripple.radius v_))
            (M3e.Build.Internal.node_ b_)
        )
...
unbounded v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Ripple.unbounded v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { ripple : M3e.Kind.Brand } msg
build b_ =
