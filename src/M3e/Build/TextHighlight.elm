...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.TextHighlight.disabled v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
mode v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TextHighlight.mode v_))
            (M3e.Build.Internal.node_ b_)
        )
...
term v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.TextHighlight.term v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { textHighlight : M3e.Kind.Brand } msg
build b_ =
