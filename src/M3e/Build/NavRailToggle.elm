module M3e.Build.NavRailToggle exposing
    ( Builder, AttrCaps, SlotCaps, navRailToggle, attr, for
    , child, build
    )

{-| The Build form for `<m3e-nav-rail-toggle>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.NavRailToggle as NavRailToggle`.

@docs Builder, AttrCaps, SlotCaps, navRailToggle, attr, for
@docs child, build
...
navRailToggle =
    M3e.Build.Internal.wrap_
        (Markup.Node.fromComponent
            (\erased_ ch_ ->
                M3e.Html.NavRailToggle.navRailToggle
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.NavRailToggle.for v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { navRailToggle : M3e.Kind.Brand } msg
build b_ =
