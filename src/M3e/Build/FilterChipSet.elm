...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | filterChipSet : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
multi v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.multi v_))
            (M3e.Build.Internal.node_ b_)
        )
...
name v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.name v_))
            (M3e.Build.Internal.node_ b_)
        )
...
vertical v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.vertical v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.onChange v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.FilterChipSet.onInput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { filterChipSet : M3e.Token.Supported } msg
build b_ =
