...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | stateLayer : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.StateLayer.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.StateLayer.for v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { stateLayer : M3e.Token.Supported } msg
build b_ =
