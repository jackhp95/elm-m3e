...
{-| The Build form for `<m3e-stepper-previous>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.StepperPrevious as StepperPrevious`.
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { stepperPrevious : M3e.Token.Supported } msg
build b_ =
