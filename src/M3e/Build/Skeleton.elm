...
animation v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Skeleton.animation v_))
            (M3e.Build.Internal.node_ b_)
        )
...
shape v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Skeleton.shape v_))
            (M3e.Build.Internal.node_ b_)
        )
...
loaded v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Skeleton.loaded v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { skeleton : M3e.Kind.Brand } msg
build b_ =
