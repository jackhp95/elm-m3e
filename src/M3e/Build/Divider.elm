...
inset v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.Divider.inset v_))
            (M3e.Build.Internal.node_ b_)
        )
...
insetStart v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.Divider.insetStart v_))
            (M3e.Build.Internal.node_ b_)
        )
...
insetEnd v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.Divider.insetEnd v_))
            (M3e.Build.Internal.node_ b_)
        )
...
vertical v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.Divider.vertical v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { divider : M3e.Token.Supported } msg
build b_ =
