...
{-| The Build form for `<m3e-dialog-trigger>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.DialogTrigger as DialogTrigger`.
...
dialogTrigger =
    M3e.Build.Internal.wrap_
        (Markup.Node.fromComponent
            (\erased_ ch_ ->
                M3e.Html.DialogTrigger.dialogTrigger
...
for v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.DialogTrigger.for v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { dialogTrigger : M3e.Kind.Brand } msg
build b_ =
