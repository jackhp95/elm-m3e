...
{-| The Build form for `<m3e-nav-menu-item-group>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.NavMenuItemGroup as NavMenuItemGroup`.
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { navMenuItemGroup : M3e.Token.Supported } msg
build b_ =
