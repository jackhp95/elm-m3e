...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | buttonGroup : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
multi v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ButtonGroup.multi v_))
            (M3e.Build.Internal.node_ b_)
        )
...
size v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ButtonGroup.size v_))
            (M3e.Build.Internal.node_ b_)
        )
...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.ButtonGroup.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { buttonGroup : M3e.Token.Supported } msg
build b_ =
