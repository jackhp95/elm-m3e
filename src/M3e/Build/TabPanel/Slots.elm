module M3e.Build.TabPanel.Slots exposing (unnamed)
...
{-| Place any child in the `unnamed` slot of `TabPanel` (an arbitrary slot — accepts any component's Builder).
-}
unnamed :
    M3e.Build.Internal.Builder ck ca cs msg
    ->
        M3e.Build.TabPanel.Builder
            pa
            { ps
