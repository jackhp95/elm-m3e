...
color v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.ThemeIcon.color v_))
            (M3e.Build.Internal.node_ b_)
        )
...
scheme v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.ThemeIcon.scheme v_))
            (M3e.Build.Internal.node_ b_)
        )
...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.ThemeIcon.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { themeIcon : M3e.Kind.Brand } msg
build b_ =
