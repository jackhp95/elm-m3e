module M3e.Build.RadioGroup exposing
    ...
    , disabled, name, required, onBeforeinput, onInput, onChange, build
    )
...
onBeforeinput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
             (M3e.Cem.Attr.Internal.forget (M3e.Cem.RadioGroup.onBeforeinput v_)
             )
             (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
             (M3e.Cem.Attr.Internal.forget (M3e.Cem.RadioGroup.onInput v_))
             (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
             (M3e.Cem.Attr.Internal.forget (M3e.Cem.RadioGroup.onChange v_))
             (M3e.Build.Internal.node_ b_)
        )
