...
type alias Builder attrCaps slotCaps msg kind =
    M3e.Build.Internal.Builder
        { kind
            | radioGroup : M3e.Token.Supported
        }
        attrCaps
        slotCaps
        msg
...
ariaInvalid v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.ariaInvalid v_))
            (M3e.Build.Internal.node_ b_)
        )
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
...
name v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.name v_))
            (M3e.Build.Internal.node_ b_)
        )
...
required v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.required v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.onInput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.RadioGroup.onChange v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    ...
    -> M3e.Element.Element { radioGroup : M3e.Token.Supported } msg
build b_ =
