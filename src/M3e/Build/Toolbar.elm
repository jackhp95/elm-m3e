...
elevated v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Toolbar.elevated v_))
            (M3e.Build.Internal.node_ b_)
        )
...
shape v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Toolbar.shape v_))
            (M3e.Build.Internal.node_ b_)
        )
...
variant v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Toolbar.variant v_))
            (M3e.Build.Internal.node_ b_)
        )
...
vertical v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.Toolbar.vertical v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { toolbar : M3e.Kind.Brand } msg
build b_ =
