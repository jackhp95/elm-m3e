module M3e.Build.NavItem exposing
    ...
    , disabledInteractive, download, href, orientation, rel, selected
    , target, onBeforeinput, onInput, onChange, onClick, child
    , icon, selectedIcon, build
    )

{-| The Build form for `<m3e-nav-item>` — phantom-typed pipeline API. Import qualified: `import M3e.Build.NavItem as NavItem`.
...
{-| Phantom-typed opaque builder for `<m3e-nav-item>`.
-}
...
disabled v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.disabled v_))
            (M3e.Build.Internal.node_ b_)
        )
    ...
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget
                (M3e.Html.NavItem.disabledInteractive v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
download v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.download v_))
            (M3e.Build.Internal.node_ b_)
        )
...
href v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.href v_))
            (M3e.Build.Internal.node_ b_)
        )
...
orientation v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.orientation v_))
            (M3e.Build.Internal.node_ b_)
        )
...
rel v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.rel v_))
            (M3e.Build.Internal.node_ b_)
        )
...
selected v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.selected v_))
            (M3e.Build.Internal.node_ b_)
        )
...
target v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.target v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onBeforeinput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.onBeforeinput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onInput v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.onInput v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onChange v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.onChange v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (M3e.Node.addAttr
            (M3e.Html.Attr.Internal.forget (M3e.Html.NavItem.onClick v_))
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> M3e.Element.Element { navItem : M3e.Token.Supported } msg
build b_ =
