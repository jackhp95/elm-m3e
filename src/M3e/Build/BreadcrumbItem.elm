...
current v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BreadcrumbItem.current v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
href v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BreadcrumbItem.href v_))
            (M3e.Build.Internal.node_ b_)
        )
...
target v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BreadcrumbItem.target v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
rel v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget (M3e.Html.BreadcrumbItem.rel v_))
            (M3e.Build.Internal.node_ b_)
        )
...
onClick v_ b_ =
    M3e.Build.Internal.wrap_
        (Markup.Node.addAttr
            (Markup.Html.Attr.Internal.forget
                (M3e.Html.BreadcrumbItem.onClick v_)
            )
            (M3e.Build.Internal.node_ b_)
        )
...
build :
    Builder a s msg kind
    -> Markup.Element.Element { breadcrumbItem : M3e.Kind.Brand } msg
build b_ =
