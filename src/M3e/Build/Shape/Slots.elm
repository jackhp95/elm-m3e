module M3e.Build.Shape.Slots exposing (unnamed)
...
{-| Place any child in the `unnamed` slot of `Shape` (an arbitrary slot — accepts any component's Builder).
-}
unnamed :
    M3e.Build.Internal.Builder ck ca cs msg
    ->
        M3e.Build.Shape.Builder
            pa
            { ps
