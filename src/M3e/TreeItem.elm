module M3e.TreeItem exposing
    ...
    , onOpened, onClosing, onClosed, onClick, label, icon
    , selectedIcon, toggleIcon, openToggleIcon
    )
...
@docs onOpened, onClosing, onClosed, onClick, label, icon
@docs selectedIcon, toggleIcon, openToggleIcon
