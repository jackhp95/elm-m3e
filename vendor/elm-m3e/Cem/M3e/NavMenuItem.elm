module Cem.M3e.NavMenuItem exposing (badgeSlot, component, disabled, iconSlot, labelSlot, onClick, onClosed, onClosing, onOpened, onOpening, open, selected, selectedIconSlot, toggleIconSlot)
