module Cem.M3e.Fab exposing (Size(..), Type(..), Variant(..), closeIconSlot, component, disabled, disabledInteractive, download, extended, href, labelSlot, lowered, name, onClick, rel, size, target, type_, value, variant)
