module Cem.M3e.BottomSheet exposing (component, detent, handle, handleLabel, headerSlot, hideFriction, hideable, modal, onCancel, onClosed, onClosing, onOpened, onOpening, open, overshootLimit)
