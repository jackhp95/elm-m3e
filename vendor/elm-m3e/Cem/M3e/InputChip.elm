module Cem.M3e.InputChip exposing (Variant(..), avatarSlot, component, disabled, disabledInteractive, iconSlot, onClick, onRemove, removable, removeIconSlot, removeLabel, trailingIconSlot, value, variant)
