module Cem.M3e.NavItem exposing (Orientation(..), component, disabled, disabledInteractive, download, href, iconSlot, onBeforeinput, onChange, onClick, onInput, orientation, rel, selected, selectedIconSlot, target)
