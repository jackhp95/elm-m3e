module M3e.AssistChip exposing (Type(..), Variant(..), component, disabled, disabledInteractive, download, href, iconSlot, name, onClick, rel, target, trailingIconSlot, type_, value, variant)
