module M3e.Optgroup.Build exposing
...
{-| The builder module for `m3e-optgroup` — seed, pipe, and close.

This module provides everything you need to BUILD with `Optgroup`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.Optgroup.view`.
...
import M3e.Optgroup as Component
