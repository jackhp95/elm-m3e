module M3e.SelectionIndicator.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.SelectionIndicator.view`.
...
import M3e.SelectionIndicator as Component
