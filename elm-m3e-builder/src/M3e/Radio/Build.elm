module M3e.Radio.Build exposing
...
{-| The builder module for `m3e-radio` — seed, pipe, and close.

This module provides everything you need to BUILD with `Radio`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.Radio.view`.
...
{-| Pipe form of `class` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `checked` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `disabled` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `name` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `required` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `value` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `onBeforeinput` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `onInput` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `onChange` — re-exported from `M3e.Radio`.
-}
...
{-| Pipe form of `onClick` — re-exported from `M3e.Radio`.
-}
