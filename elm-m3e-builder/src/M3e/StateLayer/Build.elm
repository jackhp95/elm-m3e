module M3e.StateLayer.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.StateLayer.view`.
...
import M3e.StateLayer as Component
...
{-| Pipe form of `class` — re-exported from `M3e.StateLayer`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.StateLayer`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.StateLayer`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.StateLayer`.
-}
...
{-| Pipe form of `disableHover` — re-exported from `M3e.StateLayer`.
-}
withDisableHover : Bool -> Builder { a | disableHover : Available } slotCaps msg kind -> Builder { a | disableHover : Used } slotCaps msg kind
withDisableHover =
    Component.withDisableHover


{-| Pipe form of `disabled` — re-exported from `M3e.StateLayer`.
-}
...
{-| Pipe form of `enablePressed` — re-exported from `M3e.StateLayer`.
-}
...
withEnablePressed =
    Component.withEnablePressed


{-| Pipe form of `for` — re-exported from `M3e.StateLayer`.
-}
