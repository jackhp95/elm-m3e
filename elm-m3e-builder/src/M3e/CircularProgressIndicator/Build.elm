module M3e.CircularProgressIndicator.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.CircularProgressIndicator.view`.
...
import M3e.CircularProgressIndicator as Component
