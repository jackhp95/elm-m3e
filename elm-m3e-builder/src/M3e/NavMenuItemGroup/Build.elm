module M3e.NavMenuItemGroup.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.NavMenuItemGroup.view`.
...
import M3e.NavMenuItemGroup as Component
