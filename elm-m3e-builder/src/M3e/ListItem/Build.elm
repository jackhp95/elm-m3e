module M3e.ListItem.Build exposing
...
{-| The builder module for `m3e-list-item` — seed, pipe, and close.

This module provides everything you need to BUILD with `ListItem`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.ListItem.view`.
...
import M3e.ListItem as Component
...
{-| Pipe form of `class` — re-exported from `M3e.ListItem`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.ListItem`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.ListItem`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.ListItem`.
-}
