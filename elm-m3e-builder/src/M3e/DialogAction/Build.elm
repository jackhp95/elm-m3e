module M3e.DialogAction.Build exposing
...
{-| The builder module for `m3e-dialog-action` — seed, pipe, and close.

This module provides everything you need to BUILD with `DialogAction`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.DialogAction.view`.
...
import M3e.DialogAction as Component
...
{-| Pipe form of `class` — re-exported from `M3e.DialogAction`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.DialogAction`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.DialogAction`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.DialogAction`.
-}
