module M3e.TimepickerInput.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.TimepickerInput.view`.
...
import M3e.TimepickerInput as Component
import M3e.Values
