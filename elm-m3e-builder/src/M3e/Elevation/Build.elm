module M3e.Elevation.Build exposing
    ( build, toElement, view
    , Builder, AttrCaps, SlotCaps, Is, ChildAdmittedBy
    , withClass, withDisabled, withFor, withId, withLevel, withSlot, withStyle
    )

{-| The builder module for `m3e-elevation` — seed, pipe, and close.

This module provides everything you need to BUILD with `Elevation`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.Elevation.view`.
...
import M3e.Elevation as Component
...
{-| Pipe form of `class` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `disabled` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `for` — re-exported from `M3e.Elevation`.
-}
...
{-| Pipe form of `level` — re-exported from `M3e.Elevation`.
-}
