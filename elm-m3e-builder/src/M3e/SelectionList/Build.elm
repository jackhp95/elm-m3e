module M3e.SelectionList.Build exposing
...
{-| The builder module for `m3e-selection-list` — seed, pipe, and close.

This module provides everything you need to BUILD with `SelectionList`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.SelectionList.view`.
...
import M3e.SelectionList as Component
import M3e.Values
