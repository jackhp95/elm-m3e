module M3e.ListItemButton.Build exposing
...
{-| The builder module for `m3e-list-item-button` — seed, pipe, and close.

This module provides everything you need to BUILD with `ListItemButton`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.ListItemButton.view`.
...
import M3e.ListItemButton as Component
...
{-| Pipe form of `class` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `disabled` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `download` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `href` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `rel` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `target` — re-exported from `M3e.ListItemButton`.
-}
...
{-| Pipe form of `onClick` — re-exported from `M3e.ListItemButton`.
-}
