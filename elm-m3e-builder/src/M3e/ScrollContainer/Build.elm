module M3e.ScrollContainer.Build exposing
...
{-| The builder module for `m3e-scroll-container` — seed, pipe, and close.

This module provides everything you need to BUILD with `ScrollContainer`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.ScrollContainer.view`.
...
import M3e.ScrollContainer as Component
import M3e.Values
