module M3e.LinearProgressIndicator.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.LinearProgressIndicator.view`.
...
import M3e.LinearProgressIndicator as Component
import M3e.Values
