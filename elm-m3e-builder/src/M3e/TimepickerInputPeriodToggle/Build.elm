module M3e.TimepickerInputPeriodToggle.Build exposing
...
For the standard `[attrs] [children]` constructor, use `M3e.TimepickerInputPeriodToggle.view`.
...
import M3e.TimepickerInputPeriodToggle as Component
import M3e.Values
