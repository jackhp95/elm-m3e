module M3e.MenuItemCheckbox.Build exposing
...
{-| The builder module for `m3e-menu-item-checkbox` — seed, pipe, and close.

This module provides everything you need to BUILD with `MenuItemCheckbox`
using the pipe-builder pattern. Slot placers and slot pipes accept builders
directly — no `.toElement` needed at the call site.

For the standard `[attrs] [children]` constructor, use `M3e.MenuItemCheckbox.view`.
...
import M3e.MenuItemCheckbox as Component
...
{-| Pipe form of `class` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `id` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `slot` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `style` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `checked` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `disabled` — re-exported from `M3e.MenuItemCheckbox`.
-}
...
{-| Pipe form of `onClick` — re-exported from `M3e.MenuItemCheckbox`.
-}
