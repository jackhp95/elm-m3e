...
-}
withState : Value State -> Builder { a | state : Available } slotCaps msg kind -> Builder { a | state : Used } slotCaps msg kind
withState value_ =
...
-}
withLoading : Element LoadingSlot admittedBy msg -> Builder attrCaps slotCaps msg kind -> Builder attrCaps slotCaps msg kind
withLoading element =
